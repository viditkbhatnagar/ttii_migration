...
class Cohorts extends CentreBaseController
{
    ...
    public function index(){
        ...
        $filter = [];
        $filter['centre_id'] = $this->users_model->get(['id' => get_user_id()])->getRow()->centre_id ?? null;
    ...
    public function load_cohort_assignments($id){
        ...
        return view('Centre/Assignment/cohort_assignments_index', $this->data);                                                            
    }
    ...
    public function ajax_show_submissions()
    {
        ...
        return view('Centre/Assignment/ajax_show_submissions', ['submissions' => $submissions]);
    }
    ...
    public function ajax_show_unsubmissions()
    {
        ...
        return view('Centre/Assignment/ajax_show_unsubmissions', ['unsubmissions' => $unsubmissions]);
    }
    ...
    public function load_cohort_announcements($id){
        ...
        $this->data['edit_data']['id'] = $id;
        return view('Centre/Announcement/cohort_announcement_index', $this->data);                                                            
    }
    ...
    public function cohort_add()
    {
        ...
        $this->data['centre_id'] = $this->users_model->get(['id' => $logged_in_user])->getRowArray()['centre_id'];
    ...
    public function get_students_not_in_cohort()
    {
        return $this->db->table('users')
            ...
            ->where('users.added_under_centre', $this->users_model->get(['id' => get_user_id()])->getRowArray()['centre_id'])
    ...
    public function get_students_not_in_subject()
    {
        ...
        $builder = $this->db->table('users s')
            ->where('s.role_id', 2) // only students
            ->where('s.added_under_centre', $this->users_model->get(['id' => get_user_id()])->getRowArray()['centre_id'])
            ->select('s.id as user_id, s.name, s.student_id');
    ...
    public function ajax_edit($id){
        ...
        $this->data['course'] = $this->course_model->get(['status' => 'published'])->getResultArray();
        $this->data['language'] = $this->languages_model->get()->getResultArray();
        echo view('Centre/Cohorts/ajax_edit', $this->data);
    }
    ...
    public function add_vimeo_link($live_class_id){
        ...
        echo view('Centre/Live_class/vimeo_link_add', $this->data);
    }
    ...
    public function add_live_class($cohort_id)
    {
        ...
        echo view('Centre/Live_class/live_cohort_add', $this->data);
    }
    ...
    public function assignments_add($cohort_id)
    {
        ...
        echo view('Centre/Assignment/cohort_assignments_add', $this->data);
    }
    ...
    public function assignments_edit($id)
    {
        ...
        echo view('Centre/Assignment/cohort_assignments_edit', $this->data);
    }
    ...
    public function announcements_add($cohort_id)
    {
        ...
        echo view('Centre/Announcement/cohort_announcement_add', $this->data);
    }
    ...
    public function ajax_add_learner($subject_id=null,$cohort_id=null){
        ...
        $user_id = get_user_id();
        $centre_id = $this->users_model->get(['id' => $user_id])->getRow()->centre_id ?? '';
        ...
        $builder = $this->db->table('users s')
            ->where('s.role_id', 2) // only students
            ->where('s.added_under_centre', $centre_id)
            ->where('s.deleted_at', null)
        ...
        $this->data['learners'] = $builder->get()->getResultArray();
        $this->data['cohort_id'] = $cohort_id;
        echo view('Centre/Cohorts/ajax_add_learner', $this->data);
    }
    ...
    public function delete($id){
        ...
        return redirect()->to(base_url('centre/cohorts/index'));
    }
