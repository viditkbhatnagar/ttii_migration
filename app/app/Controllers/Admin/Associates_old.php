        ...
        if ($this->request->getMethod() === 'post'){
            ...
            if($check_phone_duplication == 0 && $check_email_duplication == 0) 
            {
                ...
                if (!empty($croppedImage)) {
                    $image = $this->upload_base64_image('associates', $croppedImage);
                }
                ...
                if ($counsellor){
                    session()->setFlashdata('message_success', "Associate Added Successfully!");
                }else{
    ...
    public function edit($id){
        if ($this->request->getMethod() === 'post'){
            ...
            if($check_phone_duplication == 0 && $check_email_duplication == 0) 
            {
                ...
                $associate = $this->users_model->edit($data, ['id' => $id]);
                if ($associate){
