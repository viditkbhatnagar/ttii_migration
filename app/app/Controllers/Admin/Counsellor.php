...
class Counsellor extends AppBaseController
{
    private $users_model;
    ...
    public function index(){
        ...
        $where = [];
        $where['role_id'] = 9;
        $this->data['active_counsellors'] = $this->users_model->get($where)->getNumRows();
        if (isset($search_key)) {
        ...
        $this->data['page_title'] = 'Counsellors';
        $this->data['page_name'] = 'Counsellor/index';
    ...
    public function view($id){
        ...
        $students = $this->users_model->get_join(
            ...
            ['users.role_id' => 2, 'users.counsellor_id' => $id],
            ['users.name', 'countries.country']
        )->getResultArray();
        ...
        echo view('Admin/Counsellor/ajax_view', $this->data);
    }
    ...
    public function ajax_add(){
        ...
        echo view('Admin/Counsellor/ajax_add', $this->data);
    }
    ...
    public function add() {
        if ($this->request->getMethod() === 'post') {
            ...
            $check_phone_duplication = $this->users_model->get(['country_code' => $code, 'phone' => $phone, 'role_id' => 9])->getNumRows();
            $check_email_duplication = $this->users_model->get(['user_email' => $email,'role_id' => 9])->getNumRows();
            ...
            if ($check_phone_duplication == 0 && $check_email_duplication == 0) {
               ...
               if ($response) {
                    ...
                    session()->setFlashdata('message_success', "Counsellor Added Successfully!");
                } else {
        ...
        return redirect()->to(base_url('Admin/counsellor/index'));
    }
    ...
    public function ajax_edit($id){
        ...
        echo view('Admin/Counsellor/ajax_edit', $this->data);
    }
    ...
    public function edit($id){
        if ($this->request->getMethod() === 'post'){
            ...
            $check_phone_duplication = $this->users_model->get(['country_code' => $code , 'phone' => $phone, 'id !=' => $id, 'role_id' => 9])->getNumRows();
            $check_email_duplication = $this->users_model->get(['user_email' => $email, 'id !=' => $id , 'role_id' => 9])->getNumRows();
            if($check_phone_duplication == 0 && $check_email_duplication == 0){
                $data = [
                   'name'                  => $this->request->getPost('name'),
                    'user_email'            => $email,
                ...
                if ($response){
                    session()->setFlashdata('message_success', "Counsellor Updated Successfully!");
                }else{
                    session()->setFlashdata('message_danger', "Something went wrong! Try Again");
                }
            }else{
    ...
    public function delete($id){
        if ($id > 0){
            if ($this->users_model->remove(['id' => $id])){
                session()->setFlashdata('message_success', "Counsellor Deleted Successfully!");
            }else{
                session()->setFlashdata('message_danger', "Something went wrong! Try Again");
            }
        }else{
    ...
    public function assigned_universities($id){
        ...
        $this->data['page_name'] = 'Counsellor/assigned_universities';
        return view('Admin/index', $this->data);
    }
    public function ajax_add_universities($id) {
        ...
        echo view('Admin/Counsellor/ajax_add_university', $this->data);
    }
    ...
    public function overview(){
        ...
        $this->data['page_title'] = 'Counsellors overview';
        $this->data['page_name'] = 'Counsellor/overview';
        return view('Admin/index', $this->data);
    }
    ...
    public function performance(){
        ...
        $this->data['page_name'] = 'Counsellor/performance';
        return view('Admin/index', $this->data);
    }
    ...
    public function view_performance($id){
        ...
        $universities = $this->university_model->get()->getResultArray();
        $this->data['universities'] = array_column($universities, 'title', 'id');
        echo view('Admin/Counsellor/view_performance', $this->data);
    }
    ...
    public function admissions(){
        ...
        $this->data['page_name'] = 'Counsellor/admissions';
        return view('Admin/index', $this->data);
    }
    ...
    public function view_admission($id){
        ...
        echo view('Admin/Counsellor/view_admissions', $this->data);
    }
    ...
    public function revenue(){
        ...
        $this->data['page_name'] = 'Counsellor/revenue';
        return view('Admin/index', $this->data);
    }
    ...
    public function edit_password($id){
        if($this->request->getMethod() == 'post'){
            ...
            $this->data['edit_data'] = $this->users_model->get(['id' => $id])->getRowArray();
            return view('Admin/Counsellor/edit_password', $this->data);
        }
    }
