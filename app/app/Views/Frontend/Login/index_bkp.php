                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted">Login to continue to <?=get_site_title()?></p>
                                        <div class="p-1">
                                            <?php
                                            if (!empty($error)){
                                            ...
                                            elseif(!empty($success)){
                                             ...
                                             elseif (session()->getFlashdata('message_success') !== NULL)
                                             {
                                    ...
                                    <div class="mt-4">
                                        <form action="" method="post" name="login">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control input-hover" id="email" name="email" placeholder="Enter email">
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                <button class="btn text-white w-100 btn-hover" type="submit" style="background-color: #8f2774;">Log In</button>
                                            </div>
                                            <div class="float-end mt-4">
                                                <!--<a href="<?=base_url('login/contact')?>" class="text-muted">Contact Us</a>-->
                                            </div>
                                        </form>
                                    </div>
