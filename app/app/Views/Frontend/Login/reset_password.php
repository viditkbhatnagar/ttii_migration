                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    <div class="text-center">
                                        ...
                                        <h5 class="text-primary pt-3">Reset Password</h5>
                                    ...
                                    <div class="mt-4">
                                        <form action="<?=base_url('login/update_password')?>" method="post" name="reset_password" id="resetPasswordForm">
                                            <input type="hidden" name="email" value="<?=isset($email) ? htmlspecialchars($email) : ''?>">
                                            <input type="hidden" name="reset_token" value="<?=isset($reset_token) ? htmlspecialchars($reset_token) : ''?>">
                                            <input type="hidden" name="user_id" value="<?=isset($reset_user_id) ? (int) $reset_user_id : 0?>">
                                            <div class="mb-3">
                                                <label for="password" class="form-label">New Password</label>
                                                <input type="password" class="form-control input-hover" id="password" name="password" placeholder="Enter new password" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="confirm_password" class="form-label">Confirm New Password</label>
                                                <input type="password" class="form-control input-hover" id="confirm_password" name="confirm_password" placeholder="Confirm new password" required>
                                                <div id="password-match-message" style="color: #eb4f87; font-size: 0.95em; margin-top: 0.25em;"></div>
                                            </div>
                                            <div class="mt-4">
                                                <button class="btn text-white w-100 btn-hover" type="submit" style="background-color: #8f2774;" id="resetPasswordBtn">Reset Password</button>
                                            </div>
                                        </form>
                                        <script>
