<script>
    !(function () {
        ...
        function a(n) {
            var e;
            n.querySelector(".country-flagimg") && (e = n.querySelector(".country-flagimg").getAttribute("src")),
                Array.from(n.querySelectorAll(".dropdown-menu li")).forEach(function (r) {
                    ...
                    r.addEventListener("click", function () {
                        ...
                        var countryCodeWithoutPlus = e.replace('+', '');
                        ...
                        // Update the hidden input field with the selected country code without the +
                        n.querySelector('input[name="country_code"]').value = countryCodeWithoutPlus;
                    }),
        ...
        (e = "country-list.json"),
            (r = function (e, r) {
                if (null !== e) console.log("Something went wrong: " + e);
                    ...
                    for (let e = 0; e < o.length; e++)
                        n +=
                            '<li class="dropdown-item d-flex">            <div class="flex-shrink-0 me-2"><img src="<?=base_url()?>assets/user/images/' +
                            o[e].flagImg +
            ...
            (t = new XMLHttpRequest()).open("GET", "<?=base_url()?>assets/user/json/" + e, !0),
            (t.responseType = "json"),
            (t.onload = function () {
                var e = t.status;
            ...
            t.send(),
            Array.from(document.querySelectorAll("[data-input-flag]")).forEach(function (n) {
