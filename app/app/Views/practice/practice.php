    ...
    <div class="main__container">
        <div class="top-section">
          ...
          <div class="card-section-area">
            <div class="small-cards">
              <p><?=$practice_details['questions_count']?></p>
              <p>Questions</p>
            </div>
            <div class="small-cards">
              <p><?=$practice_details['questions_count']*4?></p>
              <p>Mark</p>
            </div>
            <div class="small-cards">
              <p><?=$practice_details['practice_time']?> Minutes</p>
              <p>Duration</p>
            </div>
          </div>
        </div>
        <div class="bottom-section">
          <div id="quiz_description">
            ...
            <ul>
                <li>The examination is of 1 minutes duration for each question.</li>
                <li> Each MCQ type question has four choices out of which only one choice is the correct answer.</li>
                <li>Each correct answer carries 4 mark and for each wrong answer 1 mark will be deducted. No negative mark for unattended questions.</li>
                ...
                <li>The answer keys are also available.</li>
            </ul>
                   
            <?php if($practice_details['questions_count'] > 0) {?>
                <div class="quiz-desciption-btn">
                    <button id="startTestButton">Start Practice</button>
                </div>
            <?php } ?>
          </div>
        </div>
    ...
    <div class="quiz_ui_attend_section hidden">
        ...
        <div class="quiz_attend_top_section">
            ...
            <div class="quiz_attent_number_cercle">
                <div class="cercle_wrapper" id="cercle_wrapper"></div>
            </div>
        </div>
        ...
        <div class="submit-item-box">
            <div class="center-item">
                <div class="success_message_actions">
                    <img src="<?=base_url()?>assets/practice/success.png" alt="" />
                </div>
...
<div id="popup" class="popup hidden">
    <div class="popup_bottom_section">
        <div class='popup__header'>
           <p>Are you sure you want to <br> submit?</p>  
        </div>
        <div class="attemted_wraper">
            <div class="attemted_left">
                <div class="attemted_cercle">
                    <img src="<?=base_url('assets/practice/vector5.png')?>" alt="" />
                  </div>
                <h3>3</h3>
                <p>Attempted</p>
            </div>
            <div class="attemted_right">
                <div class="not_attemted_cercle">
                    <img src="<?=base_url('assets/practice/vector7.png')?>" alt="" />
                </div>
                <h3>3</h3>
                <p>Unattempted</p>
            </div>
...
<script>
       document.addEventListener("DOMContentLoaded", () => {
        ...
        let timer;
        let timeLimit = <?=$practice_details['practice_time']?> * 60;
        ...
        closePopupBtn.addEventListener("click", () => {
         ...
         function save_test_start(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('exam/practice_save_start'); ?>",
                data: {
                    'user_id' : user_id,
                    'quiz_id' : quiz_id,
    ...
    // data submit section
              ...
              var formData = new FormData();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // window.location.replace("<?//=base_url('exam/show_practice_result/'.$user_id.'/'.$attempt_id)?>");
                    }
                });
      ...
      function navigatBack() {
        window.location.href = "<?=base_url('exam/practice_web_view/'.$user_id. '/' .$course_id)?>";
      }
