...
<div class="row">
    <div class="col-sm-6 col-xl-3 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="h5 mb-2">Introduction to Chemistry</h4>
                <p class="card-text">3 Lessons, 3 Videos</p>
            </div>
            <div class="card-footer">
                <a href="<?=base_url('app/Lessons/index')?>" class="btn btn-primary rounded-5 w-100">View Lessons</a>
            </div>
        </div>
    </div>
</div>
