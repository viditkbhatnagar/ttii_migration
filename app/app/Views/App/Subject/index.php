    ...
    <div class="row">
        <div class="col-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('app/course/my_course') ?>">My Course</a></li>
                ...
                <?php if(!empty($subjects)){ ?>
                    <?php foreach($subjects as $key => $subject){ ?>
                        <div class="col-12 col-md-6 col-xl-4">
                            <a href="<?= base_url('app/subject/subjects/'.$subject['id'])?>">
                            <div class="card rounded-4 mb-3">
                                <div class="card-body px-3" >
                                    <div class="ratio ratio-16x9">
                                        <img src="<?= valid_file($subject['thumbnail']) ? base_url(get_file($subject['thumbnail'])) : 'https://t3.ftcdn.net/jpg/02/48/42/64/360_F_248426448_NVKLywWqArG2ADUxDq6QprtIzsF82dMF.jpg' ?>" class="w-100" style="object-fit: cover;">
                                    </div>
                                    <h5 class=" fw-bold my-3"><?= ++$key ?>) <?= $subject['title'] ?? '' ?></h5>
        ...
        <!--<div class="col-2"> -->
        <!--<a href="</?= base_url('app/subject/subjects/'.$subject['id'])?>" class="rounded-pill px-3 py-2 text-white" style="position:absolute; bottom: 8px; background-color: #FB803D;">Continue</a>-->
        <!--</div>-->
        <div class="col-12 col-lg-3">
            <div class="card rounded-4">
                <div class="card-body">
                    <div class="circular-progress mx-auto" data-inner-circle-color="#fff" data-percentage="<?= 0 ?>" data-progress-color="#FB803D" data-bg-color="#ddd">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <p class="my-3"><i class="ri-book-open-fill text-muted"></i> Subjects 0/4</p>
                    </div>
                </div>
            </div>
            <!--<img src="<?= base_url() ?>assets/app/images/lmsdashboardcards/mylessons.png" class="w-100">-->
            <h3 class="h6 text-dark mb-3 d-none">Hours Spent</h3>
