...
<!-- snow editor -->
<!--<script src="<?=base_url()?>assets/app/libs/@ckeditor/ckeditor5-build-classic/build/ckeditor.js"></script>-->

<!-- quill js -->
<!--<script src="<?=base_url()?>assets/app/libs/quill/quill.min.js"></script>-->

<!-- init js -->
<!--<script src="<?=base_url()?>assets/app/js/pages/form-editor.init.js"></script>-->
