        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-4 mx-auto" style="max-width: 500px;">
                    ...
                    if(isset($live_class)){
                        ?>
                        <form action="<?=base_url('app/live/start/')?>" method="get" id="live_class_form">
                            ...
                            <div class="form-group">
                                ...
                                <input style="background-color:#f2f2f2" type="text" class="form-control" id="class_title" name="class_title" value="<?php echo $live_class['title']; ?>" placeholder="Enter Class/ Instructor Name" required readonly>
                                <div class="pt-3">
                                ...
                                <div class="text-center p-2 mt-2">
                                    <button type="submit" class="btn btn-primary" style="width: 200px">Join Meeting</button>
                                </div>
                            </div>
                        </form>
                        <?php
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('live_class_form').submit();
    });
