                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <button class="btn btn-md btn-primary rounded-pill float-end"
                                onclick="show_ajax_modal('<?=base_url('admin/live_class/ajax_add/')?>', 'Add Live')">
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <!--</li>-->
                                                <li>
                                                    <a href="javascript::void()" class="dropdown-item edit-item-btn" onclick="show_ajax_modal('<?=base_url('admin/live_class/ajax_edit/'.$list_item['id'])?>', 'Update Live Class')">
                                                        <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript::void()" class="dropdown-item remove-item-btn" onclick="delete_modal('<?=base_url('admin/live_class/delete/'.$list_item['id'])?>')">
                      ...
                      <div class="row">
                          <div class="col-6">
                              <div class="detail-item mb-2">
                                  ...
                                  <p class="text-muted m-0"><?=($list_item['role_id']==2) ? 'Student' : 'Instructor'?></p>
                              </div>
                              <div class="detail-item mb-2">
                          ...
                          <div class="col-6">
                              ...
                              <div class="detail-item mb-2">
                                  ...
                                  <p class="text-muted m-0"><?= date('d-m-Y', strtotime($list_item['fromDate'])) ?> To: <?= date('d-m-Y', strtotime($list_item['toDate'])) ?></p>
                              </div>
                          </div>
                      </div>
                  </div>               
                    <div class="d-flex justify-content-end">
                        <!--<button class="btn btn-outline-secondary me-2 custom-rounded-40px-srs py-1 px-3" onclick="show_ajax_modal('<?//=base_url('admin/live_class/ajax_edit/'.$list_item['id'])?>', 'Update Live Class')">-->
                        <!--    <i class="ri-pencil-fill fs-6"></i> Edit-->
                        <!--</button>-->
                        <a href="<?=base_url('zoom/index/'.$list_item['id'])?>" class="btn btn-outline-secondary me-2 custom-rounded-40px-srs py-1 px-3">
                            <i class="ri-video-chat-line"></i> Host
                        </a>
                        <button class="btn btn-outline-danger custom-rounded-40px-srs py-1 px-3" onclick="delete_modal('<?=base_url('admin/live_class/delete/'.$list_item['id'])?>')">
