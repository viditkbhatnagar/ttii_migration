...
<form autocomplete="off" action="<?=base_url('admin/live_class/add')?>" method="post"  enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 p-2">
                                <div>
                                    ...
                                    <input type="time" class="form-control select2" name="fromTime" id="fromTime" required>
                                </div>
                            </div>
                            <div class="col-lg-6 p-2">
                                <div>
                                    <label for="code" class="form-label">To Time<span class="required text-danger">*</span></label>
                                    <input type="time" class="form-control select2" name="toTime" id="toTime" required>
                                </div>
                            </div>
                            <div class="col-lg-6 p-2">
                                <div>
                                    <label for="" class="form-label">Zoom ID<span class="required text-danger">*</span></label>
                                    <input type="text" class="form-control select2" name="zoom_id" id="zoom_id" required>
                                </div>
                            </div>
                            <div class="col-lg-6 p-2">
                                <div>
                                    <label for="" class="form-label">Password<span class="required text-danger">*</span></label>
                                    <input type="text" class="form-control select2" name="password" id="password" required>
                                </div>
                            </div>
