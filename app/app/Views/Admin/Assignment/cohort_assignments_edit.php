<form autocomplete="off" action="<?= base_url('admin/assignment/edit') ?>" method="post" enctype="multipart/form-data" id="assignmentForm">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 p-2">
                                <label for="due_date" class="form-label">Due Date<span class="required text-danger">*</span></label>
                                <input type="date" class="form-control" id="due_date" name="due_date" required value="<?= $edit_data['due_date'] ?? '' ?>">
                            </div>

                            <!-- From Time -->
                            <div class="col-lg-4 p-2 d-none">
                                <label for="from_time" class="form-label">From Time<span class="required text-danger">*</span></label>
                                <input type="time" class="form-control" id="from_time" name="from_time" value="00:00:00">
                            </div>

                            <!-- To Time -->
                            <div class="col-lg-4 p-2">
                                <label for="to_time" class="form-label">Due Time<span class="required text-danger">*</span></label>
                                <input type="time" class="form-control" id="to_time" name="to_time" required value="<?= $edit_data['to_time'] ?? '' ?>">
                            </div>
                            
                            <div class="col-lg-12 p-2 mt-1">
                                <label for="attachment" class="form-label">Attachment</label>
                                <div class="dropzone" id="attachment-dropzone"></div>
                                <div id="uploadedFileNameContainer" class="mt-2">Previous Uploaded File : <a href="<?= base_url(get_file($edit_data['file'])) ?? '' ?>" target="_blank" id="uploadedFileNameLink">File</a></div>
                            </div>
                            ...
                            <div class="col-12 p-2">
                                <button class="btn btn-success float-end btn-save" type="button" id="assignmentEditBtn">
...
<script>
    ...
    $(document).ready(function() {
        ...
        ClassicEditor
            ...
            .then(editor => {
                ...
                // ✅ Set data from PHP safely
            editor.setData(`<?= addslashes(html_entity_decode($edit_data['instructions'] ?? '')) ?>`);
    ...
    $("#assignmentEditBtn").on("click", function (e) {
        e.preventDefault();
        ...
        var routeUrl = "<?=base_url('admin/assignment/edit/'.$edit_data['id'].'')?>";
