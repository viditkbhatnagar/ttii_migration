...
<script>
    ...
    $(document)
        .off("click", "#assignmentAddBtn")
        .on("click", "#assignmentAddBtn", function (e) {
            e.preventDefault();
            ...
            ajax(form, routeUrl, $btn);
        });


    function ajax(form, routeUrl, $btn) {
        var formData = new FormData(form);
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    $btn.prop("disabled", false).text("Save"); //  re-enable
                }
            },
