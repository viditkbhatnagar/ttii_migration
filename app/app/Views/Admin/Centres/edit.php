...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="<?=base_url('admin/centres/edit/'.$edit_data['id'])?>" enctype="multipart/form-data" method="post" id="centreAddform">
            ...
            <div class="col-lg-6 p-2">
                <div>
                    ...
                    <input type="text" class="form-control textOnly" id="centre_id" name="centre_id" required value="<?=$edit_data['centre_id'] ?>" readonly>
                </div>
            </div>
            <div class="col-lg-6 p-2">
                <div>
                    <label for="centre_name" class="form-label">Centre Name<span class="required text-danger">*</span></label>
                    <input type="text" class="form-control textOnly" id="centre_name" name="centre_name" required  value="<?=$edit_data['centre_name'] ?>">
                </div>
            </div>
            ...
            <div class="col-lg-4 p-2">
              ...
              <div class="col-lg-6 p-2">
                ...
                <textarea class="form-control" required name="address" required><?=$edit_data['address'] ?></textarea>
            </div>
            ...
            <div class="col-lg-6 p-2">
                <div>
                    ...
                    <input type="text" class="form-control textOnly" id="contact_person" name="contact_person" required value="<?=$edit_data['contact_person'] ?>">
                </div>
            </div>
             ...
             <div class="col-lg-6 p-2">
                <div>
                    ...
                    <input type="text" class="form-control textOnly" id="contact_person_designation" name="contact_person_designation" required value="<?=$edit_data['contact_person_designation'] ?>">
                </div>
            </div>
            ...
            <div class="col-lg-6 p-2">
                <div>
                    ...
                    <input type="text" name="whatsapp" id="whatsapp" class="form-control numbersOnly" maxinput="15" placeholder="Enter phone no" required="" value="<?=$edit_data['whatsapp'] ?>">
            ...
            <div class="col-lg-6 p-2">
                <div>
                    ...
                    <input type="email" class="form-control" id="email" name="email" required value="<?=$edit_data['email'] ?>">
                </div>
            </div>
            ...
            <div class="col-lg-6 p-2">
                <div>
                    ...
                    <input type="text" name="secondary_phone" id="secondary_phone" class="form-control numbersOnly" maxinput="15" placeholder="Enter phone no" required="" value="<?=$edit_data['secondary_phone'] ?>">
            ...
            <div class="col-lg-6 p-2">
                <div>
                    ...
                    <input type="date" class="form-control " id="date_of_registration" name="date_of_registration" required value="<?=$edit_data['date_of_registration'] ?>">
                </div>
            </div>
            <div class="col-lg-6 p-2">
                <div>
                    <label for="date_of_expiry" class="form-label">Date of Expiry<span class="required text-danger">*</span></label>
                    <input type="date" class="form-control " id="date_of_expiry" name="date_of_expiry" required  value="<?=$edit_data['date_of_expiry'] ?>">
                </div>
            </div>
            ...
            <div class="card-header align-items-center d-flex mt-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 p-2">
                                <div>
                                    <label for="password" class="form-label">Password * (keep blank if no change)</label>
                                    <div class="input-group">
                                    ...
                                    <span class="text-sm" class="form-text text-muted">*Email same as the contact email</span>
                                    <script>
