<form id="assignPlanForm" action="<?= base_url('admin/centres/save_assign_plan') ?>" method="post">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 p-2">
            <div>
                ...
                <input type="number" class="form-control" name="assigned_amount" id="assigned_amount" required>
            </div>
        </div>
        ...
        <div class="col-12 p-2">
            <button type="submit" class="btn btn-success float-end">
                <i class="ri-check-fill"></i> Assign Plan
            </button>
        </div>
