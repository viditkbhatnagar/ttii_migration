                ...
                <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link py-3 All <?= !isset($_GET['list_by']) ? 'active' : '' ?>" id="All"
                            href="<?= base_url('admin/cohorts/index') ?>" role="tab" aria-selected="true">
                            All
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-3 Active <?= (isset($_GET['list_by']) && $_GET['list_by'] == 'active') ? 'active' : '' ?>"
                            id="Active" href="<?= base_url('admin/cohorts/index?list_by=active') ?>">
                            Active
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-3 Inactive <?= (isset($_GET['list_by']) && $_GET['list_by'] == 'completed') ? 'active' : '' ?>"
                            id="Incative" href="<?= base_url('admin/cohorts/index?list_by=completed') ?>">
                            Completed
                        </a>
                    </li>
                </ul>
