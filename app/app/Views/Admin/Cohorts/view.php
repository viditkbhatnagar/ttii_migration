                    ...
                    <div class="row">
                        ...
                        <?php if (has_permission('cohorts/add')) { ?>
                            <div class="col-4 d-none">
                                <a href="<?= base_url('admin/cohorts/cohort_add/') ?>" class="btn btn-md btn-primary float-end">
    ...
    $(document).ready(function () {
        ...
        $('#pills-activities-info-tab').on('shown.bs.tab', function () {
            ...
            if (!container.data('loaded')) {
                ...
                container.load( "<?= base_url('admin/Cohorts/load_cohort_assignments/'.$edit_data['id']) ?>", function (response, status) { 
                    loader.hide();
                     if (status === "success") {
        ...
        $('#pills-announcements-info-tab').on('shown.bs.tab', function () {
            ...
            if (!container.data('loaded')) {
                ...
                container.load(
                    "<?= base_url('admin/Cohorts/load_cohort_announcements/'.$edit_data['id']) ?>",
