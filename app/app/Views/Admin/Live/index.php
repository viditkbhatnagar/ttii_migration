        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-4 mx-auto" style="max-width: 500px;">
                    ...
                    if(isset($live_class)){
                        ?>
                        <form action="<?=base_url('live/start')?>" method="get">
                            <input type="hidden" name="live_class_id" value="<?php echo $live_class['zoom_id']; ?>">
                            <div class="form-group">
                                <label for="class_title">Live Class Title <span class="text-danger">*</span> </label>
                                <input style="background-color:#f2f2f2" type="text" class="form-control" id="class_title" name="class_title" value="<?php echo strtoupper($live_class['title']); ?>" placeholder="Enter Class/ Instructor Name" required readonly>
                                <div class="pt-3">
