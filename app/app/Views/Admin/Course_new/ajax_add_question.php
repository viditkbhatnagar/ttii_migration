<div class="card shadow-sm border-0 rounded-4">
    <div class="card-header bg-primary">
        <h4 class="mb-0 text-white">
            <i class="ri-add-box-line me-2"></i>
            Add Question
        </h4>
    </div>
    <div class="card-body">
        <form action="<?= base_url('admin/course_new/add_question/' . $lesson_id.'/'.$lesson_file_id) ?>" method="post" enctype="multipart/form-data">

            <!-- Question Text -->
            <div class="mb-3">
                <label for="question" class="form-label fw-semibold">Question Text</label>
                <textarea class="form-control rounded-3 shadow-sm" id="question" name="question" rows="3" required></textarea>
            ...
            <div class="mb-3">
                ...
                <div class="btn-group" role="group">
                    <input type="radio" class="btn-check" name="question_type" id="single" value="0" autocomplete="off" checked>
                    <label class="btn btn-outline-primary" for="single">
                        <i class="ri-checkbox-circle-line me-1"></i> Single Answer
                    </label>

                    <input type="radio" class="btn-check" name="question_type" id="multiple" value="1" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <div id="answer-container">
                    <!-- Start with 2 empty answer options -->
                    <?php for ($i = 0; $i < 2; $i++): ?>
                        <div class="input-group mb-2 answer-option">
                            <span class="input-group-text bg-light">
                                <input type="radio" name="answer_id" value="<?= $i ?>">
                            </span>
