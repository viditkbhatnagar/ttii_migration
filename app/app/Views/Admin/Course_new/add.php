                                ...
                                <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="pills-gen-info" role="tabpanel" aria-labelledby="pills-gen-info-tab">
                                                <form action="<?= !(empty($edit_data)) ? base_url('admin/course_new/edit/' . $edit_data['id']) : base_url('admin/course_new/add') ?>" autocomplete="off" enctype="multipart/form-data" method="post">
