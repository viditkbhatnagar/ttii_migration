<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"><?=$page_title ?? ''?> - <?=$edit_data['title']?></h4>
                                            ...
                                            <div class="card-body">
                                                <div class="d-lg-flex align-items-center row">
                                                    ...
                                                    <div class="d-flex gap-1 justify-content-center mx-auto my-3 col-sm-5 my-lg-0">
                                                        ...
                                                        <a href="javascript::" class="btn btn-outline-info btn-sm ml-1" onclick="show_ajax_modal('<?= base_url('admin/lesson_files/ajax_add/' . $les['id'].'/video-url') ?>', 'Add Video')">
                                                            <i class="mdi mdi-plus"></i> Add Video
                                                        </a>
                                                        <a href="javascript::" class="btn btn-outline-info btn-sm ml-1 d-none" onclick="show_ajax_modal('<?= base_url('admin/lesson_files/ajax_add/' . $les['id'].'/other-pdf') ?>', 'Add Materials')">
                                                            <i class="mdi mdi-plus"></i> Add Materials
                                                        </a>
                                                        <a href="javascript::" class="btn btn-outline-info btn-sm ml-1 d-none" onclick="show_ajax_modal('<?= base_url('admin/lesson_files/ajax_add/' . $les['id'].'/other-quiz') ?>', 'Add Quiz')">
