...
<div class="row">
    <div class="col-lg-12">
        <div class="card rounded-4">
            <div class=" card-body">
                <div>
                    <form method="get" action="<?= base_url('admin/course/index') ?>">
        
                        <div class="row g-3">
                        
                            <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                                <label for="status" class="form-label">Status</label>
                                <select class="form-control select2" name="status" id="price">
                            ...
                            foreach ($list_items as $key => $list_item){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <b>
                                            <?php if (is_admin()): ?>
                                                <a href="<?= base_url('admin/course/add_details/' . $list_item['id']) ?>"
                                    ...
                                    <td><?= $list_item['category_id'] == 1 ? 'Certification' : ($list_item['category_id'] == 2 ? 'Diploma' : 'Not Selected') ?></td>
                                    <td>
                                    ...
                                    <?php
                                    $badgestyle = ($list_item['status'] == 'draft') ? 'bg-warning' : ($list_item['status'] == 'published' ? 'bg-success' : 'bg-primary');
                                    ?>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <?php
                                                if ($list_item['status'] == 'published') // if published, archive course
                                                {?>
                                                    <li>
                                                        <a class="dropdown-item edit-item-btn" href="<?=base_url('admin/course/change_status/'.$list_item['id'].'/?status=archived')?>">
                                                            <i class="ri-exchange-box-line align-bottom me-2 text-muted"></i> Archive Course
                                                        </a>
                                                    </li>
                                                    
                                                <?php
                                                }
                                                else // if draft or archived
                                                {?>
                                                    <li>
                                                        <a class="dropdown-item edit-item-btn" href="<?=base_url('admin/course/change_status/'.$list_item['id'].'/?status=published')?>">
                                                            <i class="ri-exchange-box-line align-bottom me-2 text-muted"></i> Publish Course
                                                        </a>
                                                    </li>
                                                ...
                                                ?>
                                                <li>
                                                    <a href="<?=base_url('admin/course/add/'.$list_item['id'])?>" class="dropdown-item edit-item-btn">
