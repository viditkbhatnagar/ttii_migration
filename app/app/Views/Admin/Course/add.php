        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?=base_url('admin/course/index')?>">Course</a></li>
            ...
            <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="pills-gen-info" role="tabpanel" aria-labelledby="pills-gen-info-tab">
                            <form action="<?= !(empty($edit_data)) ? base_url('admin/course/edit/' . $edit_data['id']) : base_url('admin/course/add') ?>" autocomplete="off" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="short_name" class="form-label">Course Short Name<span class="required text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="short_name" name="short_name" 
                                                        value="<?= isset($edit_data['short_name']) ? esc($edit_data['short_name']) : '' ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="category_id" class="form-label">Course Category<span class="required text-danger">*</span></label>
                                                    <select class="form-control select2" required name="category_id" id="category_id" >
                                                        <option value="" hidden >Choose Category</option>
                                                        <option value="1" <?= (isset($edit_data['category_id']) && $edit_data['category_id'] == 1) ? 'selected' : '' ?>>Certification Courses</option>
                                                        <option value="2" <?= (isset($edit_data['category_id']) && $edit_data['category_id'] == 2) ? 'selected' : '' ?>>Diploma Courses</option>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="duration" class="form-label">Course duration<span class="required text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="duration" name="duration" 
                                                        value="<?= isset($edit_data['duration']) ? esc($edit_data['duration']) : '' ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="description" class="form-label">Course Description</label>
                                                    <textarea class="form-control"  name="description" rows="3" id="editor" >
                                           ...
                                           <div class="col-12">
                                            <div class="mb-3">
                                                <label for="features" class="form-label">Who should enrol (points per line)</label>
                                                <textarea id="features" name="features" class="form-control" rows="5"><?= isset($edit_data['features']) ? esc($edit_data['features']) : '' ?></textarea>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="row">
                                            <div class="col-12">
                                                    ...
                                                    <p class="text-muted">Image Aspect ratio should be 1200x628 - Max File size 100KB</p>
                                                    <input type="file" class="form-control" id="thumbnail" name="thumbnail">
                                                    <?php if (isset($edit_data['thumbnail']) && $edit_data['thumbnail']): ?>
                                                    <br>
                                                        <p>Current Thumbnail: <img src="<?=base_url(get_file($edit_data['thumbnail']))?>" alt="Thumbnail" width="100"></p>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <!-- <div class="col-12">
                                                    ...
                                                    </?php if (isset($edit_data['banner']) && $edit_data['banner']): ?>
                                                    <br>
                                                        <p>Current banner: <img src="</?=base_url(get_file($edit_data['banner']))?>" alt="banner" width="100"></p>
                                                    </?php endif; ?>
                                                </div>
                                            </div> -->
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="gen-info-username-input">Pricing<span class="required text-danger">*</span></label>
                                                    <br>
                                                    <!-- Inline Radios -->
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="is_free_course" id="is_free_course" required value="1"
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="gen-info-username-input">Course Type<span class="required text-danger">*</span></label>
                                                    <br>
                                                    <!-- Inline Radios -->
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="is_cohort_course" id="is_cohort_course" required value="1"
                                                            <?= (isset($edit_data['is_cohort_course']) && $edit_data['is_cohort_course'] == 1) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="is_cohort_course">Cohort Course</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="is_cohort_course" id="is_paid_course" value="0"
                                                            <?= (isset($edit_data['is_cohort_course']) && $edit_data['is_cohort_course'] == 0) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="is_paid_course">Non Cohort Course</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="gen-info-username-input">Publish Type<span class="required text-danger">*</span></label>
                                                    <br>
                                                    <!-- Inline Radios -->
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="is_public" id="is_public" required value="1"
                                                            <?= (isset($edit_data['is_public']) && $edit_data['is_public'] == 1) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="is_public">Public</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="is_public" id="is_paid_course" value="0"
                                                            <?= (isset($edit_data['is_public']) && $edit_data['is_public'] == 0) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="is_paid_course">Private</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="gen-info-username-input">Referral Point<span class="required text-danger">*</span></label>
                                                    <div class="form-check form-check-inline">
                                                        <input type="number" class="form-control" name="point" id="point" value="<?= isset($edit_data['point']) ? esc($edit_data['point']) : '' ?>"
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex align-items-start gap-3 mt-4">
                                <button type="button" class="btn btn-link text-decoration-none btn-label previestab" data-previous="pills-gen-info-tab">
                                    <a href="<?=base_url('admin/course/index')?>"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i> Back to Home</a>
                                </button>
                                <button type="submit" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="pills-info-desc-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Add more info</button>
                            </div>
                            ...
                            <div>
                                ...
                                <?php } else { ?>
                                    <div class="text-center mt-5">
                                        ...
                                        <!-- Add Subject Button -->
                                        <button class="btn btn-md btn-primary d-none"
...
$(document).ready(function () {
    $(".form-steps").on("submit", function (event) {
        ...
        let existingThumbnail = <?= isset($edit_data['thumbnail']) && $edit_data['thumbnail'] ? 'true' : 'false' ?>;


        // Validate Thumbnail (only if no previous thumbnail exists)
        if (!existingThumbnail && $thumbnailInput[0].files.length === 0) {
