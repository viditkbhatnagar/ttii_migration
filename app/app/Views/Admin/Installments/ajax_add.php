<form action="<?= base_url('admin/fee_management/add_installment/' . $student_id) ?>" method="post"
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                <select class="form-control" id="payment_status_select" name="status" required>
...
<script>
    $(document).ready(function () {
        $(document).off('change', '#payment_status_select'); // remove duplicate handlers
        $(document).on('change', '#payment_status_select', function () {
            togglePaymentDate();
        });
    ...
    function togglePaymentDate() {
            let statusSelect = document.getElementById("payment_status_select");
