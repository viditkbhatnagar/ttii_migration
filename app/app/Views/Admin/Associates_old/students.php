                    ...
                    <div class="col-8">
                      ...
                      <div class="col-4">
                        <button class="btn btn-md btn-primary float-end"
                                onclick="show_small_modal('<?=base_url('admin/instructor/ajax_assign/'.$instructor)?>', 'Assign Student')">
                            Assign Student
                        </button>
                    </div>
                </div>
                        ...
                        if (isset($list_items)){
                            foreach ($list_items as $key => $list_item){
                                ...
                                <tr>
                                   ...
                                   <td><?=$date?></td>
                                   <td>
                                        <a href="javascript::void()" class="dropdown-item remove-item-btn" onclick="delete_modal('<?=base_url('admin/instructor/assign_delete/'.$list_item['id'])?>')">
