                                ...
                                <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                    ...
                                                                                    <input type="number" class="form-control" id="price" name="price" 
                                                                                        value="<?= isset($edit_data['price']) ? esc($edit_data['price']) : '' ?>" >
                                                                            </div>
                                                                            <div class="col-6">
                                                                                    <label for="sale_price" class="form-label">Sale Price</label>
                                                                                    <input type="number" class="form-control" id="sale_price" name="sale_price" 
                                                                                        value="<?= isset($edit_data['sale_price']) ? esc($edit_data['sale_price']) : '' ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="tab-pane fade show active" id="pills-info-desc" role="tabpanel" aria-labelledby="pills-info-desc-tab">
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <a href="<?=base_url('admin/course/'.$course_id)?>" class="btn btn-link text-decoration-none btn-label previestab" data-previous="pills-gen-info-tab">
