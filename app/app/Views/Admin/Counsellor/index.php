            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="<?=$active_counsellors ?? 0 ?>"></span></h2>
                    </div>
                    <div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <button class="btn btn-md btn-primary float-end"
                                onclick="show_ajax_modal('<?=base_url('admin/counsellor/ajax_add/')?>', 'Add counsellor')">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-3 col-sm-4">
                            <div class="d-flex">
                                ...
                                <a href="<?= base_url('admin/counsellor/index') ?>" class="btn btn-danger w-100 py-2">
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item" onclick="show_ajax_modal('<?=base_url('admin/counsellor/view/'.$list_item['id'])?>','View counsellor')">
                                                        <i class="ri-eye-fill align-bottom me-2 text-muted"></i> View
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item edit-item-btn" onclick="show_ajax_modal('<?=base_url('admin/counsellor/ajax_edit/'.$list_item['id'])?>', 'Update counsellor Details')">
                                                        <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item remove-item-btn" onclick="delete_modal('<?=base_url('admin/counsellor/delete/'.$list_item['id'])?>')">
                                                        <i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="dropdown-item" onclick="show_small_modal('<?=base_url('admin/counsellor/edit_password/'.$list_item['id'])?>','Edit Email and Password')">
                                                        <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Change Username/Password
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?= $list_item['drop_out_status'] == 0 ? base_url('admin/counsellor/active_status/'.$list_item['id']) : base_url('admin/counsellor/inactive_status/'.$list_item['id']) ?>" class="dropdown-item <?= $list_item['drop_out_status'] == 0 ? 'text-success' : 'text-danger'; ?>">
