                    ...
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                        <div class="row g-4">
                            ...
                            <div class="col">
                                <div class="p-2">
                                    ...
                                    <div class="hstack -50 gap-1">
                                        ...
                                        <!-- <i class="ri-map-pin-user-line me-1  text-opacity-75 fs-16 align-middle"></i></?=$view_data['address']?><br> -->
                                        <?=$view_data['course_title'] ?? ''?><br>
                                        <?=$view_data['batch_title'] ?? '' ?></div>
                            ...
                            <!--end col-->
                            <?php if(is_admin() || is_centre()) {?>
                            <div class="col-6 col-lg-auto order-last ">
                                <button type="button" class="btn btn-success" id="convertbtn"> <a href="javascript:void(0);" 
                                    onclick="confirmConversion('<?= base_url('admin/applications/convert/' . $view_data['id']) ?>')" 
                                    class="dropdown-item"><i class="ri-arrow-left-right-line"></i>
                                     Convert to Student
                                </a></button>
                                <br>
                                <span class="text-white mt-3"><?php if(isset($view_data['centre_name']) && !empty($view_data['centre_name'])) { ?>Note : Application Created By Centre <br> - <?=$view_data['centre_name'] ?? ''?> <?php } ?></span>
                                <br>
                                <a href="<?= base_url('admin/applications/reject_application/' . $view_data['id']) ?>" class="btn btn-danger" id="rejectbtn"><i class="ri-closeline"></i> Reject Application</a>
                            </div>
                            <?php } ?>
                        </div>
                        <!--end row-->
                                    ...
                                    <div class="tab-pane active" id="overview-tab" role="tabpanel">
                                        <div class="row">
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted"><?=date('d-m-Y', strtotime($view_data['date_of_birth']))?></td>
                                                                    </tr>
                                                                     <tr>
                                                                        <th class="ps-0" scope="row">Age :</th>
                                                                        <td class="text-muted"><?=$view_data['age']?></td>
                                                                    </tr>
                                                                     <tr>
                                                                        <th class="ps-0" scope="row">Gender :</th>
                                                                        <td class="text-muted"><?=$view_data['gender']?></td>
                                                                    </tr>
                                                                    
                                                                     <tr class="d-none">
                                                                        <th class="ps-0" scope="row">Nationality :</th>
                                                                        <td class="text-muted"><?=$view_data['nationality']?></td>
                                                                    </tr>
                                                                     <tr>
                                                                        <th class="ps-0" scope="row">Marital Status :</th>
                                                                        <td class="text-muted"><?=$view_data['marital_status']?></td>
                                                                    </tr>
                                                                    
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Aadhar Number :</th>
                                                                        <td class="text-muted"><?=$view_data['aadhar_no']?></td>
                                                                    </tr>
                                                                    
                                                                    <?php
                                                                    if(!empty($view_data['passport_no']))
                                                                    { ?>
                                                                        <tr>
                                                                            <th class="ps-0" scope="row">Passport No :</th>
                                                                            <td class="text-muted"><?=$view_data['passport_no']?></td>
                                                                        </tr>
                                                                    <?php
                                                                    }
                                                                    ?>
                                            ...
                                            <div class="col-xxl-8">
                                                            ...
                                                            <div class="live-preview">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <label for="nameInput" class="form-label">Second Phone </label>
                                                                        </div>
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"><?=$view_data['second_code']?>  <?=$view_data['second_phone']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['whatsapp_no']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3">
                                                                            <label for="nameInput" class="form-label">Primary Address  </label>
                                                                        </div>
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['address']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3">
                                                                            <label for="nameInput" class="form-label">Correspondence Address  </label>
                                                                        </div>
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['native_address']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3">
                                                                            <label for="nameInput" class="form-label">Country  </label>
                                                                        </div>
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['country']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['state']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['district']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="live-preview">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"><?=$view_data['father_name']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['mother_name']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['guardian_name']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="live-preview">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"><?=$view_data['emergency_name']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['emergency_phone']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['emergency_relation']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <?php
                                                if(!empty($view_data['learning_disabilities']))
                                                { ?>
                                                            ...
                                                            <div class="live-preview">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"><?=$view_data['learning_disabilities']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['accessibility_needs']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                ...
                                                ?>
                                                 ...
                                                 <?php
                                                if(!empty($view_data['marketing_source']))
                                                { ?>
                                                            ...
                                                            <div class="live-preview">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"><?=$view_data['marketing_source']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="live-preview">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"> <?=$view_data['highest_qualification']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3">
                                                                            <label for="nameInput" class="form-label">School/College*</label>
                                                                        </div>
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['previous_school']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['year_of_passing']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['percentage_or_grade']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['teaching_experience']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"><?=$view_data['employment_status']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="live-preview">
                                                        <form action="javascript:void(0);">
                                                            ...
                                                            <?php
                                                            if($view_data['employment_status'] == 'Employed')
                                                            {
                                                            ?>
                                                                <div class="row mb-3">
                                                                    <div class="col-lg-3">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <h5 class="fs-14 text-truncate mb-1">
                                                                            :&nbsp;<a href="#" class="text-body"><?=$view_data['organization_name']?></a>
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <h5 class="fs-14 text-truncate mb-1">
                                                                            :&nbsp;<a href="#" class="text-body"><?=$view_data['designation']?></a>
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <h5 class="fs-14 text-truncate mb-1">
                                                                            :&nbsp;<a href="#" class="text-body"><?=$view_data['experience_years']?></a>
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                                 ...
                                                                 <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <h5 class="fs-14 text-truncate mb-1">
                                                                            :&nbsp;<a href="#" class="text-body"><?=$view_data['industry_sector']?></a>
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="live-preview">
                                                                <form action="javascript:void(0);">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body"> <?=$view_data['course_title']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['batch_title']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=date('d M Y',strtotime($view_data['created_at']))?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['enrollment_status']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['mode_of_study']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <h5 class="fs-14 text-truncate mb-1">
                                                                                :&nbsp;<a href="#" class="text-body">  <?=$view_data['language_title']?></a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
    ...
    function confirmConversion(url) {
        if (confirm('Are you sure you want to convert this application to a student?')) {
            ...
            document.getElementById("convertbtn").innerHTML = '<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span> Converting...';
