            ...
            <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                <li class="nav-item">
                    <a class="nav-link py-3 All <?= !isset($_GET['list_by']) ? 'active' : '' ?>" id="All"
                        href="<?= base_url('admin/applications/index?' . http_build_query(array_merge($params, ['list_by' => null]))) ?>" role="tab" aria-selected="true">
                        All
                    </a>
                </li>
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link py-3 New </?= (isset($_GET['list_by']) && $_GET['list_by'] == 'pending') ? 'active' : '' ?>"
                        id="New" href="</?= base_url('admin/applications/index?' . http_build_query(array_merge($params, ['list_by' => 'pending']))) ?>">
                        Pending
                ...
                <li class="nav-item">
                    <a class="nav-link py-3 Rejected <?= (isset($_GET['list_by']) && $_GET['list_by'] == 'rejected') ? 'active' : '' ?>"
                        id="Rejected" href="<?= base_url('admin/applications/index?' . http_build_query(array_merge($params, ['list_by' => 'rejected']))) ?>">
                        Rejected
                        <span class="badge bg-danger align-middle ms-1">
                            <?= $rejected_count ?>
                        </span>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?= !empty($student['centre_name']) ? $student['centre_name'] . ' ( ' . $student['centre_id'] . ' )' : '' ?></td>
                                <td>
