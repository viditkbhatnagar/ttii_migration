<form action="<?=base_url('admin/associates_target/add') ?>" method="post" enctype="multipart/form-data" id="myForm">
    <div class="row">
        
        <div class="col-12 col-md-6 form-group p-2">
            <label for="associate_id" class="form-label">Associate<span class="required text-danger">*</span></label>
            <select class="form-control select2" name="associate_id" id="associate_id" required>
