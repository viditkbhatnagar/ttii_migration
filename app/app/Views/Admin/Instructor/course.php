                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <button class="btn btn-md btn-primary float-end"
                                onclick="show_small_modal('<?=base_url('admin/instructor/ajax_enrol/'.$instructor)?>', 'Enrol Course')">
                            Enrol Course
                        </button>
                    </div>
                </div>
                    ...
                    <?php
                        if (isset($list_items)){
                            foreach ($list_items as $key => $list_item){
                                ...
                                <tr>
                                     <td><?=$key + 1?></td>
                                    <td><?= $user[$list_item['instructor_id']] ?? '' ?></td>
                                    <td><?= $course[$list_item['course_id']] ?? '' ?></td>
                                    <td><?=$date?></td>

                                    <td>
                                        <a href="javascript::void()" class="dropdown-item remove-item-btn" onclick="delete_modal('<?=base_url('admin/instructor/enrol_delete/'.$list_item['id'])?>')">
