<?php
    if (isset($edit_data)){
        ?>
        <form action="<?=base_url('admin/instructor/edit/'.$edit_data['id'])?>" method="post" enctype="multipart/form-data">
             <div class="row">
            ...
            <div class="modal fade" id="image-crop-modal" tabindex="-1" aria-labelledby="image-crop-modalLabel" aria-hidden="true" style="z-index: 9999;">
                ...
                <div class="col-lg-12 p-2">
                    <div>
                        ...
                        <textarea class="form-control" id="editor" name="biography" ><?=$edit_data['biography'] ?></textarea>
                    </div>
                </div>
