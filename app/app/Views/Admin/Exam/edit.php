...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="<?=base_url('admin/exam/edit/'.$edit_data['id'])?>" enctype="multipart/form-data" method="post" id="centreAddform">
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="mark" name="mark" required value="<?=$edit_data['mark']?>">
                        </div>
                            ...
                            <select class="form-control select2" name="batch_id" id="batch_id" required >
                                <option value="0">Select Batch</option>
                                   <?php foreach($batch as $val){ ?>
                                    <option value="<?=$val['id']?>" <?=($edit_data['batch_id']==$val['id']) ? 'selected' : '' ?>><?=$val['title']?></option>
                                    <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="start_date" name="from_date" required value="<?=$edit_data['from_date']?>">
                        </div>
                        
                        <div class="col-md-6">
                            <label for="end_date" class="form-label">End Date<span class="required text-danger">*</span></label>
                            <input type="date" class="form-control" id="end_date" name="to_date" required value="<?=$edit_data['to_date']?>" >
                        </div>
                        
                        <div class="col-md-4">
                            <label for="start_date" class="form-label">Start Time<span class="required text-danger">*</span></label>
                            <input type="time" class="form-control" id="from_time" name="from_time" required value="<?=$edit_data['from_time']?>">
                        </div>
                        ...
                        <div class="col-12 p-2 form-group">
                            ...
                            <textarea class="form-textarea editor" name="description" id="editor1"><?=$edit_data['description']?></textarea>
                        </div>
