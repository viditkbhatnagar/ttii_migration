        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?=base_url('admin/resources')?>">Resources</a></li>
...
<div class="file-manager-content w-100 p-3 py-0">
    ...
    <button class="btn btn-md btn-outline-primary rounded-pill d-inline-flex align-items-center px-3"
            ...
            onclick="show_ajax_modal('<?= base_url('admin/resources/ajax_add_file/' . $folder_id) ?>', 'Upload File')">
    ...
    <button class="btn btn-md btn-primary rounded-pill d-inline-flex align-items-center px-3"
            style="white-space: nowrap;"
            onclick="show_ajax_modal('<?= base_url('admin/Resources/ajax_add/' . $folder_id) ?>', 'Add Folder')">
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item view-item-btn" href="<?=base_url('admin/resources/index/' . $folder['id'])?>">Open</a></li>
                                                <li>
                                                    <a  class="dropdown-item edit-folder-list" href="javascript:void(0);"
                                                        onclick="show_ajax_modal('<?= base_url('admin/Resources/ajax_rename/' . $folder['id']) ?>', 'Rename Folder')">
                                                        Rename
                                                    </a>
                                                </li>
                                                <li><a class="dropdown-item" href="<?=base_url('admin/resources/delete_folder/' . $folder['id'])?>">Delete</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!--CLICKABLE SECTION-->
                                    <div class="card bg-light shadow-sm border-0 p-3 folder-card"
                                        onclick="window.location='<?= base_url('admin/resources/index/' . $folder['id']) ?>'"
                                        style="cursor: pointer;">

                                        <div class="text-center mb-2">
                                            <i class="ri-folder-2-fill text-warning display-5"></i>
                                        </div>

                                        <h6 class="text-center fw-semibold fs-14 mb-1"><?= esc($folder['name']) ?></h6>

                                        <?php if (!empty($folder['centre_name'])): ?>
                                        <div class="text-center">
                                            <span class="badge bg-primary-subtle text-primary fw-medium px-3 py-1">
                                                <?= esc($folder['centre_name']) ?>
                                            </span>
                                        </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a class="dropdown-item view-item-btn" href="javascript:void(0);"
                                                        onclick="show_ajax_modal('<?= base_url('admin/resources/ajax_view_file/' . $file['id']) ?>', 'View File')">View</a></li>
                                                <li><a class="dropdown-item" href="<?=base_url('admin/resources/download/' . $file['id'])?>"download>Download</a></li>
                                                <li><a class="dropdown-item" href="<?=base_url('admin/resources/delete_file/' . $file['id'])?>">Delete</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card bg-light shadow-none"
                                           style="cursor: pointer;"
                                           onclick="show_ajax_modal('<?= base_url('admin/resources/ajax_view_file/' . $file['id']) ?>', 'View File')">
                                        <div class="text-center">
                                        <div class="mb-2">
                                            ...
                                            if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif'])) {
                                                ...
                                                $icon = 'ri-file-fill'; // default icon for unknown types
                                            }
                                            ?>
                                            <!--icon-->
...
//             window.location.href = '/admin/resources/index/' + folderId;
//         });
//     });
...
//             window.location.href = '/admin/resources/view/' + fileId;
//         });
//     });
// });
 </script>