    ...
    function websdkready() {
        ...
        <?php
            if (isset($live_class)){
                ...
                var JOIN_URL = "<?=base_url('Zoom/meeting/')?>";
                var SIGNATURE_URL = "<?=base_url('Zoom/generate_signature')?>";
                var USER_NAME = "Training Institute of India"; // BASE 64 ENCODED
                var ROLE = "1"; //1 FOR HOST 0 FOR ATTEND, USE 0 FOR STUDENTS
                <?php
            }
        ?>
