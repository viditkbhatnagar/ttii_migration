<?php
    if (isset($edit_data)){
        ?>
        <form action="<?=base_url('admin/demo_video/edit/'.$edit_data['id'])?>" method="post"  enctype="multipart/form-data" id="lessonFileForm">
            <div class="row">
                <div class="col-12 form-group p-2">
                    ...
                    <select class="form-control select2" data-toggle="select2" name="course_id" id="course_id" required>
                        ...
                        <?php foreach($courses as $course){ ?>
                            <option value="<?=$course['id']?>" <?php if($edit_data["course_id"]==$course['id'])echo "selected"; ?>><?=$course['title']?></option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div class="col-lg-12 p-2">
                    <div>
                        ...
                        <select class="form-control" name="video_type" id="video_type">
                            <option value="vimeo" <?php if($edit_data["video_type"] == 'vimeo')echo "selected"; ?>>Vimeo</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-12 p-2 youtube_vimeo">
                    <div>
                        ...
                        <input type="text" id="video_url" name="video_url" class="form-control" placeholder="video url" value="<?=$edit_data['video_url']?>" onchange="checkURLValidity(this.value); cleanVimeoUrl();">
                    </div>
                </div>
