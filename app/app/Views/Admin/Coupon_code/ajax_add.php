<form action="<?=base_url('admin/coupon_code/add')?>" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-6 form-group p-2">
            ...
            <input type="number" class="form-control" name="total_no" required>
        </div>
        <div class="col-6 form-group p-2">
            <label for="title" class="form-label">No of times per user<span class="required text-danger">*</span></label>
            <input type="number" class="form-control" name="per_user_no" required>
        </div>
        <div class="col-6 form-group p-2">
        ...
        <div class="col-6 form-group p-2">
            ...
            <input type="number" class="form-control" name="discount_perc" >
        </div>
