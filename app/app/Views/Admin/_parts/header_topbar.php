    ...
    <div class="layout-width">
        <div class="navbar-header" style="background:#FAF9F6;">
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger text-dark" id="topnav-hamburger-icon">
                ...
                <form class="app-search d-none">
                    <div class="position-relative">
                        <input type="text" class="form-control text-dark" placeholder="Search..." autocomplete="off" id="search-options" value="">
            ...
            <div class="d-flex align-items-center ">
                        ...
                        <form class="p-3">
                            <div class="form-group m-0">
                                <div class="input-group">
                                    <input type="text" id="search-input" class="form-control" placeholder="Search ..." aria-label="Recipient's username">
                ...
                <!-- </?php if(get_role_id() != 1){ ?>
                    <div class="dropdown topbar-head-dropdown ms-1 header-item d-none" id="notificationDropdown">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"></?=get_notifications()->getNumRows() ?? 0;?><span class="visually-hidden">unread messages</span></span>
                        </button>
                            ...
                            <div class="tab-content position-relative d" id="notificationItemsTabContent">
                                <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        </?php $notifications = get_notifications()->getResultArray();
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user" style="background: #FAF9F6;">
                    ...
                    <?php if (has_permission('global_calender/index')): ?>
                        <li class="nav-item list-unstyled"> 
                            <a class="nav-link menu-link <?= show_active_menu($page_name, 'global_calender/index') ?>" 
                               href="<?= base_url('admin/global_calender/index/') ?>">
                                <i class= "ri-calendar-check-line text-dark fs-4 pe-3"></i>
                    ...
                    <!--chat support icon-->
                    <?php if (has_permission('chat_support/index')): ?>
                        <li class="nav-item list-unstyled"> 
                            <a class="nav-link menu-link <?= show_active_menu($page_name, 'chat_support/index') ?>" 
                               href="<?= base_url('admin/chat_support/index/') ?>">
                    ...
                    <?php if (has_permission('notification/index')): ?>
                        <li class="nav-item list-unstyled"> 
                            <a class="nav-link menu-link <?= show_active_menu($page_name, 'notification/index') ?>" 
                               href="<?= base_url('admin/notification/index/') ?>">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-flex flex-column text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text text-dark"><?=get_role_title()?></span>
                            </span>
                        </span>
                    </button>
...
<style>
    ...
    #search-options::placeholder {
        color: black;
        opacity: 0.5; /* Optional: make it fully visible */
    }
</style>
