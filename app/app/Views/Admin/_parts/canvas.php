...
<script>
    function canvas_top(url, header) {
        $('#offcanvasTop .offcanvas-body').html('<div style="padding:20px; text-align:center;"><img src="<?=base_url('assets/')?>loading.gif" width="100"></div>');
    ...
    function canvas_bottom(url, header) {
        $('#offcanvasBottom .offcanvas-body').html('<div style="padding:20px; text-align:center;"><img src="<?=base_url('assets/')?>loading.gif" width="100"></div>');
    ...
    function canvas_left(url, header) {
        $('#offcanvasLeft .offcanvas-body').html('<div style="padding:20px; text-align:center;"><img src="<?=base_url('assets/')?>loading.gif" width="100"></div>');
    ...
    function canvas_right(url, header) {
        $('#offcanvasRight .offcanvas-body').html('<div style="padding:20px; text-align:center;"><img src="<?=base_url('assets/')?>loading.gif" width="100"></div>');
