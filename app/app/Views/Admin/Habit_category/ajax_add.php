<form action="<?=base_url('admin/habit_category/add')?>" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-12 form-group p-2">
            <label for="icon" class="form-label">Icon<span class="required text-danger">*</span></label>
