...
<?php
    if (isset($edit_data)){
        ?>
        <form action="<?=base_url('admin/category/edit/'.$edit_data['id'])?>" method="post" enctype="multipart/form-data">
                <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-lg-6 p-2">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="code" name="code" value="<?=$edit_data['code'] ?>" readonly>
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-6 p-2">-->
                                            <!--    <div>-->
                                            <!--        <label for="year" class="form-label">Year<span class="required text-danger">*</span></label>-->
                                            <!--        <input type="number" class="form-control" id="year" name="year" value="<?=$edit_data['year'] ?>" required>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            <!--end col-->
                                            <div class="col-lg-6 p-2">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="name" required value="<?=$edit_data['name'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 p-2 d-none">
                                                ...
                                                <select class="form-control select2" name="parent">
                                                    ...
                                                    <?php foreach($categories as $val){ ?>
                                                            <option value="<?=$val['id']?>" <?php if($edit_data["parent"]==$val['id'])echo "selected"; ?>  ><?=$val['name']?></option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-lg-6 p-2">
                                                <div>
                                                    <label for="font_awesome_class">Icon Picker</label>
                                                     <input type="text" name="icon" id="icon-picker-input" class="form-control" placeholder="Select Icon" value="<?=$edit_data['font_awesome_class']?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 p-2">
                                                <div>
                                                    ...
                                                    <input type="file" class="form-control" id="image" name="category_thumbnail" >
