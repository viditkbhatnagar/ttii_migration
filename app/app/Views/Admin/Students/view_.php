                                ...
                                <div class="tab-content pt-1 text-muted">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-1">
                                                <i class="ri-book-open-line text-muted fs-20 me-3"></i>
                                                <h4 class="mb-0"> <?=$enrol_data['course_title'] ?? '' ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="row g-3">
                                        ...
                                        <div class="card w-100">
                                            <div class="card-body">
                                            <i class="ri-team-fill "></i><h5 class="card-title">Batch</h5>
                                            <p class="card-text"> <?=$enrol_data['batch_title'] ?? '' ?></p>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="card w-100">
                                            <div class="card-body">
                                            <i class="ri-calendar-fill"></i><h5 class="card-title">Enrollment Date</h5>
                                            <p class="card-text"><?php if (isset($enrol_data['enrolment_date'])) { echo $enrol_data['enrolment_date']; } ?></p>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="card w-100">
                                            <div class="card-body">
                                            <i class="ri-flag-2-fill"></i><h5 class="card-title">Enrollment Status</h5>
                                            <p class="card-text"><?=$enrol_data['enrollment_status'] ?? '' ?></p>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
