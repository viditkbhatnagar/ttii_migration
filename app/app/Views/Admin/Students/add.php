    ...
    <div class="d-flex justify-content-between align-items-center m-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="<?= base_url('admin/students/index') ?>" class="text-muted">Students</a></li>
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs mb-4" id="studentTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['user_id']) ? base_url('admin/students/edit/' . $edit_data['user_id'] . '?active=1') : base_url('admin/students/add?active=1') ?>"
            ...
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['user_id']) ? base_url('admin/students/edit/' . $edit_data['user_id'] . '?active=2') : base_url('admin/students/add?active=2') ?>"
            ...
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['user_id']) ? base_url('admin/students/edit/' . $edit_data['user_id'] . '?active=3') : base_url('admin/students/add?active=3') ?>"
            ...
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['user_id']) ? base_url('admin/students/edit/' . $edit_data['user_id'] . '?active=4') : base_url('admin/students/add?active=4') ?>"
            ...
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['user_id']) ? base_url('admin/students/edit/' . $edit_data['user_id'] . '?active=5') : base_url('admin/students/add?active=5') ?>"
             ...
             <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['user_id']) ? base_url('admin/students/edit/' . $edit_data['user_id'] . '?active=6') : base_url('admin/students/add?active=6') ?>"
        ...
        <div class="tab-content" id="studentTabsContent">
            ...
            <div class="tab-pane fade <?= ($activeTab == 1) ? 'show active' : ''; ?>" id="basic" role="tabpanel">
               <form action="<?= base_url('admin/students/' . (isset($edit_data['user_id']) ? 'edit/' . $edit_data['user_id'] : 'add')) ?>" method="post" enctype="multipart/form-data">
                    <div class="row g-3">
                                ...
                                <div class="position-relative d-inline-block" style="margin-top: 30px;margin-bottom: 10px;">
                                    ...
                                    <div class="avatar-lg">
                                        ...
                                        <div class="avatar-title bg-light rounded-circle">
                                            <?php 
                                            if (isset($edit_data['profile_picture']) && !empty($edit_data['profile_picture'])) { ?>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control numbersOnly" id="aadhar_no" maxlength="12" pattern="\d{12}" name="aadhar_no" placeholder="0000 0000 0000 0000"  value="<?= isset($edit_data['aadhar_no']) ? $edit_data['aadhar_no'] : '' ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control numbersOnly" id="passport_no" name="passport_no" placeholder="X0000000"  value="<?= isset($edit_data['passport_no']) ? $edit_data['passport_no'] : '' ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="password" class="form-label">Password<span class="text-danger">* <?= isset($edit_data['password']) ? '(keep blank if you dont want to change password)' : '' ?></span></label>
                                <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password" required  autocomplete="off">
                                <!-- value="</?= isset($edit_data['password']) ? $edit_data['password'] : '' ?>" -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control textOnly" id="emergency_relation" name="emergency_relation" placeholder="Enter Relationship" required value="<?= isset($edit_data['emergency_relation']) ? $edit_data['emergency_relation'] : '' ?>">
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-pane fade <?= ($activeTab == 2) ? 'show active' : ''; ?>" id="course" role="tabpanel">
                <?php if (!isset($edit_data['user_id'])) : ?>
                    <div class="alert alert-warning" role="alert">
                        Add basic info first
                    </div>
                <?php endif; ?>
               <form action="<?= base_url('admin/students/' . (isset($edit_data['user_id']) ? 'edit_education/' . $edit_data['user_id'] : 'add_education')) ?>" method="post" enctype="multipart/form-data" class="row g-3">
                    ...
                    <?php
                    if(isset($edit_data['user_id']))
                    { ?>
                        <input type="hidden" name="user_id" id="user_id" value="<?=$edit_data['user_id']?>" >
                    <?php
                    }
                    ?>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="highest_qualification" name="highest_qualification" required>
                                ...
                                <option value="Intermediate" <?php if (isset($edit_data['highest_qualification']) && $edit_data['highest_qualification'] == 'Intermediate') echo 'selected'; ?>>Intermediate</option>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="previous_school" class="form-label">Previous School/College<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="previous_school" name="previous_school" placeholder="Enter Previous School/College" required value="<?= isset($edit_data['previous_school']) ? $edit_data['previous_school'] : '' ?>">
                        </div>
                    </div>
                                    ...
                                    <thead class="table-light">
                                        ...
                                        if (!empty($qualification)) {
                                            foreach ($qualification as $q) {
                                                $qualificationData[$q['qualification']] = $q; // keeps last record if duplicate
                                            }
                                        }

                                        // Loop only the fixed 4 qualifications
                                        $qualifications = ['High_school', 'Senior_Secondary', 'Degree', 'Post_Graduate'];
                                        foreach ($qualifications as $index => $qual) :
                                            $board = $qualificationData[$qual]['board'] ?? '';
                                            $percentage = $qualificationData[$qual]['percentage'] ?? '';
                                            $certificate = $qualificationData[$qual]['certificate'] ?? '';
                                            $marksheet = $qualificationData[$qual]['marksheet'] ?? '';
                                        ?>
                                            <tr>
                                                <td><?= $index + 1 ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <input  type="file" name="certificate[]" class="form-control mt-2 file-input" accept=".pdf,.jpg,.jpeg,.png" <?= isset($edit_data['id']) ? '' : 'disabled' ?>>
                                                ...
                                                <td>
                                                    <?php if (isset($edit_data['id'])) : ?>
                                                        <button type="button" class="btn btn-sm btn-danger delete-row"
                                                            onclick="delete_modal('<?= base_url('admin/students/delete_qualification?id=' . $edit_data['id'] . '&qual=' . $qual) ?>')">
                                                            Delete
                                                        </button>
                                                    <?php else : ?>
            ...
            <div class="tab-pane fade <?= ($activeTab == 3) ? 'show active' : ''; ?>" id="qualification" role="tabpanel">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="text-end">
                            <a class="btn mb-2 btn-secondary <?= isset($edit_data['user_id']) ? '' : 'disabled' ?>" onclick="<?= isset($edit_data['user_id']) ? "show_ajax_modal('".base_url('admin/students/ajax_enrol/'.$edit_data['user_id'])."', 'Enrol New Course')" : '#' ?>">
                                <i class="ri-add-line"></i> Enrol New Course
                            </a>
                        </div>
                    </div>    
                </div>
                <?php foreach ($enrol_data as $key => $enrol):  ?>
                    <form id="qualificationForm"
                        action="<?= isset($edit_data['user_id']) ? base_url('admin/students/enrol_course/' . $edit_data['user_id']) : '#' ?>"
                        method="post" enctype="multipart/form-data" class="row g-3 mb-5">
                    
                        <!-- Course Selection Section -->
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="course" class="form-label">Course<span class="text-danger">*</span></label>
                                <select class="form-control course_select" id="course_select_<?= $key ?>" name="course" required data-index="<?= $key ?>">
                                    <option value="0">Select Course</option>
                                    <?php foreach ($course as $val) { ?>
                                        <option value="<?= $val['id'] ?>" <?= isset($enrol['course_id']) && $enrol['course_id'] == $val['id'] ? 'selected' : '' ?> data-price="<?= $val['sale_price'] ?>">
                                            <?= $val['title'] ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="batch_id" name="batch_id" required>
                                    ...
                                    <?php foreach ($batch as $val) { ?>
                                        <option value="<?= $val['id'] ?>" <?= isset($enrol['batch_id']) && $enrol['batch_id'] == $val['id'] ? 'selected' : '' ?>>
                                            <?= $val['title'] ?>
                                        </option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="enrollment_date" name="enrollment_date" required
                                    value="<?= isset($enrol['enrollment_date']) ? $enrol['enrollment_date'] : '' ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="enrollment_status" name="enrollment_status" required>
                                    ...
                                    <option value="Active" <?= isset($enrol['enrollment_status']) && $enrol['enrollment_status'] == 'Active' ? 'selected' : '' ?>>Active</option>
                                    <option value="On Hold" <?= isset($enrol['enrollment_status']) && $enrol['enrollment_status'] == 'On Hold' ? 'selected' : '' ?>>On Hold</option>
                                    <option value="Dropped" <?= isset($enrol['enrollment_status']) && $enrol['enrollment_status'] == 'Dropped' ? 'selected' : '' ?>>Dropped</option>
                                    <option value="Alumni" <?= isset($enrol['enrollment_status']) && $enrol['enrollment_status'] == 'Alumni' ? 'selected' : '' ?>>Alumni</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="mode_of_study" name="mode_of_study" required>
                                    ...
                                    <option value="Online" <?= isset($enrol['mode_of_study']) && $enrol['mode_of_study'] == 'Online' ? 'selected' : '' ?>>Online</option>
                                    <option value="Offline" <?= isset($enrol['mode_of_study']) && $enrol['mode_of_study'] == 'Offline' ? 'selected' : '' ?>>Offline</option>
                                    <option value="Hybrid" <?= isset($enrol['mode_of_study']) && $enrol['mode_of_study'] == 'Hybrid' ? 'selected' : '' ?>>Hybrid</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="preferred_language" name="preferred_language" required>
                                    ...
                                    <?php foreach ($language as $val) { ?>
                                        <option value="<?= $val['id'] ?>" <?= isset($enrol['preferred_language']) && $enrol['preferred_language'] == $val['id'] ? 'selected' : '' ?>>
                                            <?= $val['title'] ?>
                                        </option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="discounted_amount" class="form-label">Discounted Amount ₹<span class="text-danger">*</span></label>

                                <span class="text-muted" id="price_info_<?= $key ?>" style="display: none;">
                                    Course Price: <b id="course_price_view_<?= $key ?>">₹ 0</b>, 
                                    Discount: <b id="discount_perc_view_<?= $key ?>">0%</b>
                                </span>

                                <!-- User enters discounted amount -->
                                <input type="number" 
                                    class="form-control discounted_amount"
                                    id="discounted_amount_<?= $key ?>"
                                    data-index="<?= $key ?>"
                                    step="0.01"
                                    placeholder="Enter discounted price"
                                    value="<?php 
                                        if (isset($enrol['discount_perc']) && isset($enrol['course_id'])) {
                                            // Calculate discounted amount from stored percentage
                                            $coursePrice = 0;
                                            foreach ($course as $val) {
                                                if ($val['id'] == $enrol['course_id']) {
                                                    $coursePrice = $val['sale_price'];
                                                    break;
                                                }
                                            }
                                            echo $coursePrice - ((int)$coursePrice * (int)$enrol['discount_perc'] / 100);
                                        }
                                    ?>">

                                <!-- Hidden field that stores the percentage for backend -->
                                <input type="hidden" 
                                    class="form-control" 
                                    id="discount_perc_<?= $key ?>"
                                    name="discount_perc"
                                    value="<?= isset($enrol['discount_perc']) ? $enrol['discount_perc'] : '' ?>">
                            </div>
                        </div>
                        ...
                        $(document).ready(function () {
                            ...
                            function updatePrices(index) {
                                let courseSelect = document.getElementById("course_select_" + index);
                                let discountedAmountInput = document.getElementById("discounted_amount_" + index);
                                let discountPercInput = document.getElementById("discount_perc_" + index);
                                let priceInfo = document.getElementById("price_info_" + index);

                                if (!courseSelect || !discountedAmountInput || !discountPercInput) {
                                    console.log("Missing elements for index:", index);
                                    return;
                                }

                                let price = parseFloat(
                                    courseSelect.selectedOptions[0].getAttribute("data-price")
                                ) || 0;

                                let discountedAmount = parseFloat(discountedAmountInput.value);

                                // Check if discounted amount is empty or not a valid number
                                if (!discountedAmountInput.value || isNaN(discountedAmount)) {
                                    // Hide the price info and clear the hidden field
                                    priceInfo.style.display = "none";
                                    discountPercInput.value = "";
                                    return;
                                }

                                // Calculate discount percentage from the discounted amount
                                let discountPerc = 0;
                                if (price > 0 && discountedAmount <= price) {
                                    discountPerc = ((price - discountedAmount) / price) * 100;
                                }

                                // Update the hidden field with calculated percentage
                                discountPercInput.value = discountPerc.toFixed(2);

                                // Update display and show info
                                $("#course_price_view_" + index).text("₹ " + price.toFixed(2));
                                $("#discount_perc_view_" + index).text(discountPerc.toFixed(2) + "%");
                                priceInfo.style.display = "block";
                            }

                            // When either field changes
                            $(".course_select, .discounted_amount").on("change input", function () {
                    ...
                    <hr style="border-color: #007c25ff; border-width: 5px;">
                <?php endforeach; ?>
                            ...
                            <?php foreach ($course_details as $course) { ?>
                                ...
                                <div class="row justify-content-center mb-5">
                                    ...
                                    <div class="col-12 mb-4 text-center">
                                        ...
                                        <div class="underline mx-auto" style="width:70px; height:4px; background:#28a745; border-radius:4px;"></div>
                                    </div>
                                                ...
                                                <div class="card border-0 shadow-lg rounded-4 h-100 bg-light">
                                                    <div class="card-header bg-success bg-gradient text-white p-3 rounded-top-4">
                                                        <h5 class="mb-0 d-flex align-items-center text-white">
                                                            <i class="ri-price-tag-3-line fs-4 me-2"></i> Fee Structure
                                                        </h5>
                                                    </div>

                                                    <div class="card-body px-4 py-4">

                                                        <?php if (!empty($course['total_amount'])) { ?>

                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            <span class="fw-semibold text-dark">Price</span>
                                                            <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 fs-5 rounded-pill">
                                                                ₹<?= $course['price'] ?>
                                                            </span>
                                                        </div>

                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            <span class="fw-semibold text-dark">Sale Price</span>
                                                            <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 fs-5 rounded-pill">
                                                                ₹<?= $course['sale_price'] ?>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            <span class="fw-semibold text-dark">Discounted Price</span>
                                                            <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 fs-5 rounded-pill">
                                                            ₹<?= number_format(
                                                                    $course['sale_price'] - 
                                                                    ((int)$course['sale_price'] * ((int)$course['discount_perc'] / 100)),
                                                                    2
                                                                ) ?>

                                                                (<?= $course['discount_perc'] ?>%)
                                                            </span>
                                                        </div>

                                                        <?php } else { ?>
                                                            <p class="text-muted text-center">No fee structure available.</p>
                                                        <?php } ?>
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="card border-0 shadow-lg rounded-4 h-100">
                                                    <div class="card-header bg-secondary bg-gradient text-white p-3 rounded-top-4">
                                                        <h5 class="mb-0 d-flex align-items-center text-white">
                                                            <i class="ri-wallet-3-line fs-4 me-2"></i> Payment Summary
                                                        </h5>
                                                    </div>
                                                    ...
                                                    <div class="card-body px-4 py-4">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            ...
                                                            <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 fs-5 rounded-pill">
                                                                ₹<?= $course['total_amount'] ?>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            <span class="fw-semibold text-dark">Discounted Amount</span>
                                                            <span class="badge bg-success bg-opacity-10 text-info px-3 py-2 fs-5 rounded-pill">
                                                                ₹<?= number_format( $course['sale_price'] - 
                                                                    ((int)$course['sale_price'] * ((int)$course['discount_perc'] / 100)),2) ?>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <span class="badge bg-danger bg-opacity-10 text-danger px-3 py-2 fs-5 rounded-pill">
                                                                ₹<?= number_format($course['pending_amount'],2) ?>
                                                            </span>
                                                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="text-end mt-3">
                                <?php
                                        $user_id   = $edit_data['user_id'] ?? null;
                                        $course_id = $this->data['edit_data']['course_id'] ?? null;

                                        $url = base_url('admin/student_fee/add' 
                                            . ($user_id ? "/$user_id" : '')
                                            . ($course_id ? "/$course_id" : '')
                                        );
                                    ?>
                                <button 
                                    class="btn btn-primary rounded-3 <?= $user_id ? '' : 'disabled' ?>" 
                                    onclick="<?= $user_id ? "show_ajax_modal('$url', 'Add Payment')" : '' ?>"
                                >
                                ...
                                <div class="table-responsive">
                                    <table class=" table table-bordered">
                                        ...
                                        <tbody id="payment-rows">
                                            <?php if (isset($edit_data['user_id']) && !empty($this->data['edit_data']['course_id'])) : ?>
            ...
            <div class="tab-pane fade <?= ($activeTab == 5) ? 'show active' : ''; ?>" id="documents" role="tabpanel">
                ...
                <?php endif; ?>
                    ...
                    <div class="text-end">
                        <a class="btn mb-2 btn-secondary <?= isset($edit_data['user_id']) ? '' : 'disabled' ?>"
                            onclick="show_ajax_modal('<?= base_url('admin/students/document_add/' . (isset($edit_data['user_id']) ? $edit_data['user_id'] : '')) ?>', 'Add Document')">
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class=" table table-bordered">
                                ...
                                <tbody id="qualification-rows">
                                    <?php if (isset($edit_data['user_id']) && !empty($documents)) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-secondary"
                                                        onclick="show_ajax_modal('<?= base_url('admin/students/document_edit/' . $doc['student_document_id'] . '?student_id=' . $edit_data['user_id']) ?>', 'Update Document')">
                                                        Update
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        onclick="delete_modal('<?= base_url('admin/students/document_delete/' . $doc['student_document_id'] . '?student_id=' . $edit_data['user_id']) ?>')">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
              ...
              <div class="tab-pane fade <?= ($activeTab == 6) ? 'show active' : ''; ?>" id="lms" role="tabpanel">
                <div class="row g-3">
                    ...
                    <form action="<?= base_url('admin/students/' . (isset($edit_data['user_id']) ? 'edit_info/' . $edit_data['user_id'] : 'add_info')) ?>" method="post" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-12 col-md-6 d-none">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="username" name="username" placeholder="Enter Username"  value="<?= isset($edit_data['phone']) ? $edit_data['phone'] : '' ?>" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-12 col-md-6 ">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password"  value="</?= isset($edit_data['password']) ? $edit_data['password'] : '' ?>" autocomplete="off">
                            </div>
                        </div> -->
                    <?php
                        }
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="student_id" class="form-label">Unique Student ID<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="student_id" name="student_id" placeholder="Enter Unique Student ID" required value="<?= isset($edit_data['student_id']) ? $edit_data['student_id'] : '' ?>">
                            </div>
                        </div>
...
<script>
    ...
    document.querySelectorAll('.textOnly').forEach(function (element) {
        element.addEventListener('input', function () {
    ...
    function getStates(selectedCountry, selectedState = null) {
        ...
        if (selectedCountry) {
            ...
            $.ajax({
                url: 'https://countriesnow.space/api/v0.1/countries/states',   //https://countriesnowapi-jev3.onrender.com/api/v0.1/countries/states
                type: 'POST',
...
$(document).ready(function(){
    ...
    $('#email').on('input', function() {
        ...
        typingTimer = setTimeout(function() {
            $.ajax({
                url: "<?= base_url('admin/students/ajax_verify_email') ?>",
                method: "POST",
                data: {email: email},
                dataType: "json",
