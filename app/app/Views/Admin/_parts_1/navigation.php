<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box" style="margin-top: 10px;">
        ...
        <a href="<?=base_url('admin/dashboard/index')?>" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="<?=get_image_url(19)?>" alt="" height="17">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown <?php show_report_menu($page_name) ?>" id="sidebarPage4">
                                    <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="<?=base_url('admin/applications/index')?>" class="nav-link <?php show_active_menu($page_name, 'applications/index')?>" data-key="t-gallery">Applications</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="<?=base_url('admin/students/index')?>" class="nav-link <?php show_active_menu($page_name, 'students/index')?>" data-key="t-gallery">Students</a>
                                                </li>
                                    </ul>
                                </div>
                            </li>
