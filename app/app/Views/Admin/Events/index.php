                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <button class="btn btn-md btn-primary rounded-pill float-end"
                                onclick="show_ajax_modal('<?=base_url('admin/events/ajax_add/')?>', 'Add Event')">
                        ...
                        if (isset($list_items)){
                            foreach ($list_items as $key => $list_item){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        $decoded_objectives = json_decode($list_item['objectives'], true); 
                                        if (is_array($decoded_objectives) && !empty($decoded_objectives)) : ?>
                                            <ul>
                                                <?php foreach($decoded_objectives as $decoded_objective): ?>
                                                    <li><?= htmlspecialchars($decoded_objective) ?></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        <?php else: ?>
