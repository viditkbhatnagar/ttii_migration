                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <!--</li>-->
                                                <li>
                                                    <a href="javascript::void()" class="dropdown-item edit-item-btn d-none" onclick="show_ajax_modal('<?=base_url('admin/live_class/ajax_edit/'.$list_item['id'])?>', 'Update Live Class')">
              ...
              <div class="card card-animate rounded-4  border">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-end">
                        <button class=" btn btn-outline-secondary me-2 custom-rounded-40px-srs py-1 px-3" onclick="show_ajax_modal('<?=base_url('admin/live_class/ajax_edit/'.$list_item['id'])?>', 'Update Live Session')">
