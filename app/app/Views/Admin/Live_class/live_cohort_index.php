                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-2">
                        <button class="btn btn-sm btn-primary rounded-pill float-start"
                                onclick="show_ajax_modal('<?= base_url('admin/Cohorts/add_live_class/' . $edit_data['id']) ?>', 'Add Live Session')">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button class="btn btn-outline-warning custom-rounded-40px-srs py-1 px-3 me-2"
                                            onclick="show_ajax_modal('<?= base_url('admin/Cohorts/add_vimeo_link/' . $list_item['id']) ?>', 'Edit Recorded link')">
                                        <i class="ri-edit-line"></i> Edit Recorded link
                                    </button>
                                    <?php } else { ?>
                                    <button class="btn btn-success custom-rounded-40px-srs py-1 px-3 me-2"
                                            onclick="show_ajax_modal('<?= base_url('admin/Cohorts/add_vimeo_link/' . $list_item['id']) ?>', 'Add Recorded link')">
                                    ...
                                    <div class="flex-grow-3">
                                       <button class="btn btn-light btn-sm ">
                                        ...
                                        <button class="btn btn-outline-secondary btn-sm ">
                                             <a class="dropdown-item" href="#" onclick="show_ajax_modal('<?= base_url('admin/Cohorts/add_vimeo_link/' . $list_item['id']) ?>', 'Edit Recorded link')">
                                    ...
                                    <!-- <div class="flex-shrink-0 ">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#" onclick="show_ajax_modal('<?= base_url('admin/Cohorts/add_vimeo_link/' . $list_item['id']) ?>', 'Add Recorded link')">
    ...
    $(document).on("click", "#liveClassDeleteBtn", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url('admin/live_class/delete') ?>",
                    type: "POST",
                    data: { id: liveClassId },
                    dataType: "json",
