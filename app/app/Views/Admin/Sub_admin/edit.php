<?php
    if (isset($edit_data)){
        ?>
        <form action="<?=base_url('admin/sub_admin/edit/'.$edit_data['id'])?>" method="post">
            <div class="row">
                ...
                <div class="col-12 form-group p-2">
                    ...
                    <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="<?=$edit_data['user_email']?>" required>
                </div>
                <div class="col-12 form-group p-2">
                    <label for="password" class="form-label">Password<span class="required text-danger">(keep blank if not change)</span></label>
