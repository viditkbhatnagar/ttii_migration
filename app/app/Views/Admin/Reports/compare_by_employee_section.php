        ...
        <div style="background-color: transparent!important;">
            <div class="pt-3">
                ...
                <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('app/reports/index/employee')?>">
                            COMPARE BY EMPLOYEE
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <form id="filterForm" action="<?=base_url('app/reports/employee')?>" method="post">
                    <div class="row m-4">
                        <div class="col-lg-6">
                            <div class="row m-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="custom-dropdown">
                                         <select class="form-control team select2" id="primary_team_id" name="primary_team_id[]" multiple placeholder="Select Team">

                                            <?php foreach($teams as $team){ ?>
                                                <?php if(in_array($team['id'], $pteam_ids)) { ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="custom-dropdown">
                                       <select class="form-control employee select2" id="primary_employee_id" name="primary_employee_id[]" multiple >
                                            <?php
                                            if(!empty($pteam_ids))
                                            {?>
                                                <?php foreach($employees as $employee){ ?>
                                                    <?php if(in_array($employee['id'], $puser_ids)) { ?>
                        ...
                        <div class="col-lg-6">
                            <div class="row m-3">
                                <div class="col-lg-6">
                                    <label for="team_id">Team:</label>
                                    <div class="custom-dropdown">
                                        <select class="form-control team select2" id="secondary_team_id" name="secondary_team_id[]" multiple placeholder="Select Team">

                                            <?php foreach($teams as $team){ ?>
                                                <?php if(in_array($team['id'], $steam_ids)) { ?>
                                                    <option value="<?=$team['id']?>" selected><?=$team['title']?></option>
                                                <?php } else { ?>
                                                    <option value="<?=$team['id']?>"><?=$team['title']?></option>
                                                <?php } ?>
                                ...
                                <div class="col-lg-6">
                                    <label for="employee_id">Employee:</label>
                                    <div class="custom-dropdown">
                                        <select class="form-control employee select2" id="secondary_employee_id" name="secondary_employee_id[]" multiple >
                                            <?php
                                            if(!empty($steam_ids))
                                            {?>
                                                <?php foreach($employees as $employee){ ?>
                                                    <?php if(in_array($employee['id'], $suser_ids)) { ?>
                                                        <option value="<?=$employee['id']?>" selected><?=$employee['name']?></option>
                                                    <?php } else { ?>
                                                        <option value="<?=$employee['id']?>"><?=$employee['name']?></option>
                                                    <?php } ?>
                ...
                <div class="tab-content text-muted">
                    <div class="tab-pane active" id="nav-border-justified-compare-employee" role="tabpanel">
                                            ...
                                            <div class="card card-animate">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between">
                                                        <div class="report-card-data">
                                                              <?php
                                            if($total_time_at_work_1 != 0)
                                            {
                                                $productivity_rate = intval($total_productive_time_2/$total_time_at_work_1*100);
                                            }
                                            else
                                            {
                                                $productivity_rate = 0;
                                                ...
                                                <div class="card-body p-1">
                                                   ...
                                                   <?php
                                                    ...
                                                    {?>
                                                        ...
                                                        $most_productive_count  = sizeof($most_productive_1);
                                                       
                                                        foreach($most_productive_1 as $key => $val)
                                                        {
                                        ...
                                        <div class="col-6">
                                            <div class="card card-height-100 card-animate">
                                                ...
                                                {?>
                                                    ...
                                                    $most_unproductive_count  = sizeof($most_unproductive_1);
                                                   
                                                    foreach($most_unproductive_1 as $key => $val)
                                                    {
                                            ...
                                            <div class="card card-height-100 card-animate">
                                                ...
                                                <div class="card-body p-1">
                                                    ...
                                                    {?>
                                                        ...
                                                        $most_effective_count  = sizeof($most_effective_1);
                                                       
                                                        foreach($most_effective_1 as $key => $val)
                                                        {
                                                        ?>
                                                            <li class="list-group-item">
                                                                <div class="d-flex align-items-center">
                                        ...
                                        <div class="col-6">
                                            <div class="card card-height-100 card-animate">
                                                ...
                                                {?>
                                                    ...
                                                    $desktime_data_count  = sizeof($desktime_data_1);
                                                   
                                                    foreach($desktime_data_1 as $key => $val)
                                                    {
                                            ...
                                            <div class="card card-animate">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between">
                                                        <div class="report-card-data">
                                                            <?php
                                            if($total_time_at_work_2 != 0)
                                            {
                                                $productivity_rate = intval($total_productive_time_2/$total_time_at_work_2*100);
                                            }
                                            else
                                            {
                                                $productivity_rate = 0;
                                            ...
                                            <div class="card card-height-100 card-animate">
                                                ...
                                                <div class="card-body p-1">
                                                    ...
                                                    {?>
                                                        ...
                                                        $most_productive_count  = sizeof($most_productive_2);
                                                       
                                                        foreach($most_productive_2 as $key => $val)
                                                        {
                                            ...
                                            <div class="card card-height-100 card-animate">
                                                ...
                                                <div class="card-body p-1">
                                                    ...
                                                    {?>
                                                        ...
                                                        $most_unproductive_count  = sizeof($most_unproductive_2);
                                                       
                                                        foreach($most_unproductive_2 as $key => $val)
                                                        {
                                            ...
                                            <div class="card card-height-100 card-animate">
                                                ...
                                                <div class="card-body p-1">
                                                    ...
                                                    {?>
                                                        ...
                                                        $most_effective_count  = sizeof($most_effective_2);
                                                       
                                                        foreach($most_effective_2 as $key => $val)
                                                        {
                                                        ?>
                                                            <li class="list-group-item">
                                                                <div class="d-flex align-items-center">
                                        ...
                                        <div class="col-6">
                                            <div class="card card-height-100 card-animate">
                                                ...
                                                {?>
                                                    ...
                                                    $desktime_data_count  = sizeof($desktime_data_2);
                                                   
                                                    foreach($desktime_data_2 as $key => $val)
                                                    {
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#secondary_team_id').change(function() {
            var teamIds = $(this).val(); // Get selected team ids
                $.ajax({
                    type: 'POST',
                    url: base_url+'Advanced_report/getEmployeesByTeam', // Adjust the URL as per your routes
                    ...
                    success: function(response) {
                        // Clear existing options
                        $('#secondary_employee_id').empty();
                        // Add new options
                        $.each(response, function(index, employee) {
                            $('#secondary_employee_id').append('<option value="' + employee.user_id + '">' + employee.user_name + '</option>');
                        });
                    }
                });
            });
