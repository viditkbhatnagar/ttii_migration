...
if(!is_employee()){
    ...
    <div class="row">
        <div class="col-xl-3 col-md-5">
            <a href="<?=base_url('app/reports/productive_report/')?>">
        ...
        foreach($teams_list as $team){ ?>
            <div class="col-xl-3 col-md-5">
                <a href="<?=base_url('app/reports/productive_report/'.$team['id'])?>">
                ...
                <div class="card-body">
                    <table id="" class="data_table_basic table table-bordered nowrap table-striped align-middle" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th style="width: 120px;">Productive Hour</th>
                        ...
                        <tbody>
                            ...
                            { 
                                foreach($productive_data as $key => $data)
                                { 
