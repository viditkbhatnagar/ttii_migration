                    ...
                    <table id="" class="data_table_basic table table-bordered nowrap table-striped align-middle" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" class="btn btn-primary" onclick="show_ajax_modal('<?=base_url('app/idle_time/ajax_view/'.$data['id'].'/'.$from_date.'/'.$to_date)?>', 'Details')">View Details</a>
                                </td>
