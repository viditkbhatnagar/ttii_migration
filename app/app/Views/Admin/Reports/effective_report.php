...
if(!is_employee()){
    ...
    <div class="row">
        <div class="col-xl-3 col-md-5">
            <a href="<?=base_url('app/reports/effective_report/')?>">
        ...
        foreach($teams_list as $team){ ?>
            <div class="col-xl-3 col-md-5">
                <a href="<?=base_url('app/reports/effective_report/'.$team['id'])?>">
                ...
                <div class="card-body">
                    <table id="" class="data_table_basic table table-bordered nowrap table-striped align-middle" style="width:100%">
                        ...
                        <tr>
                         ...
                         <tbody>
                            <?php
                            if(!empty($effective_data))
                            { 
                                foreach($effective_data as $key => $data)
                                { 
