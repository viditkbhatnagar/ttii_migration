        ...
        <div style="background-color: transparent!important;">
            <div class="pt-3">
                ...
                <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('app/reports/index/date')?>">
                            COMPARE BY DATE
                        </a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="row m-3">
                                <div class="col-lg-4">
                                    ...
                                    <div class="custom-dropdown">
                                        <select class="form-control" id="primary_export_period" name="primary_export_period">
                        ...
                        <div class="col-lg-6">
                            <div class="row m-3">
                                <div class="col-lg-4">
                                    <label for="export_period">Date Period:</label>
                                    <div class="custom-dropdown">
                                        <select class="form-control" id="secondary_export_period" name="secondary_export_period">
                                            <option value="yesterday" selected>Yesterday</option>
                                            <option value="previous_week">Previous Week</option>
                                            <option value="previous_month">Previous Month</option>
                                            <option value="custom">Custom</option>
                                ...
                                <div class="col-lg-4">
                                    <label for="export_period">From Date:</label>
                                    <div class="custom-dropdown">
                                        <input type="date" class="form-control" id="secondary_from_date" name="secondary_from_date" value="<?php echo date('Y-m-d', strtotime('-1 day')); ?>" required readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <label for="export_period">To Date:</label>
                                    <div class="custom-dropdown">
                                        <input type="date" class="form-control" id="secondary_to_date" name="secondary_to_date" value="<?php echo date('Y-m-d', strtotime('-1 day')); ?>" required readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-content text-muted">
                    <div class="tab-pane active" id="nav-border-justified-compare-date" role="tabpanel">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#primary_export_period").change(function () {
        ...
        $("#secondary_export_period").change(function () {
            // Get the selected option value
            var selectedValue = $(this).val();

            // Disable date fields by default
            $("#secondary_from_date, #to_date2").prop("readonly", true);

            // If 'Custom' is selected, enable date fields and make them required
            if (selectedValue === "custom") {
                $("#secondary_from_date, #secondary_to_date").prop("readonly", false).prop("required", true);
            } else {
                // Handle other options (Yesterday, Previous week, Previous month) here
                // You can customize the logic for each option based on your requirements
                // For simplicity, I'm setting default values for 'Yesterday', 'Previous week', and 'Previous month'
                ...
                if (selectedValue === "yesterday") {
                    var yesterday = new Date(today);
                    yesterday.setDate(today.getDate() - 1);
                    $("#secondary_from_date").val(formatDate(yesterday));
                    $("#secondary_to_date").val(formatDate(yesterday));
                } else if (selectedValue === "previous_week") {
                    var lastWeek = new Date(today);
                    lastWeek.setDate(today.getDate() - 7);
                    $("#secondary_from_date").val(formatDate(lastWeek));
                    $("#secondary_to_date").val(formatDate(today));
                } else if (selectedValue === "previous_month") {
                    var lastMonth = new Date(today);
                    lastMonth.setMonth(today.getMonth() - 1);
                    $("#secondary_from_date").val(formatDate(lastMonth));
                    $("#secondary_to_date").val(formatDate(today));
                }
            }
        });
