...
if(!is_employee()){
    ...
    <div class="row">
        <div class="col-xl-3 col-md-5">
            <a href="<?=base_url('app/private_time/report/')?>">
        ...
        foreach($teams_list as $team){ ?>
            <div class="col-xl-3 col-md-5">
                <a href="<?=base_url('app/private_time/report/'.$team['id'])?>">
                    ...
                    <table id="" class="data_table_basic table table-bordered nowrap table-striped align-middle" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 120px;">Total Private Time</th>
                        ...
                        <tbody>
                            ...
                            if(!empty($list_items))
                            { 
                                foreach($list_items as $key => $data)
                                { 
                                 $seconds = $data['total_private_time'];
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" class="btn btn-primary" onclick="show_ajax_modal('<?=base_url('app/private_time/ajax_view/'.$data['id'].'/'.$from_date.'/'.$to_date)?>', 'Details')">View Details</a>
                                </td>
