        ...
        <div class="card-body bg-white p-3 mb-2">
            ...
            <div class="table-responsive">
                <table id="" class="data_table_basic table table-bordered nowrap table-striped align-middle" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        if (isset($associate_point_ranking)) {
                            foreach ($associate_point_ranking as $key => $point_ranking) { ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
        ...
        <div class="card-body bg-white p-3 mb-2">
            ...
            <div class="table-responsive">
                <table id="" class="data_table_basic table table-bordered nowrap table-striped align-middle" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        if (isset($associate_count_ranking)) {
                            foreach ($associate_count_ranking as $key => $count_ranking) { ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
