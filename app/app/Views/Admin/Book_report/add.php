        ...
        <ul class="nav nav-tabs mb-4" id="studentTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['user_id']) ? base_url('admin/students/edit/' . $edit_data['user_id'] . '?active=2') : base_url('admin/students/add?active=2') ?>"
                    ...
                    <i class="ri-book-open-line me-1"></i>Academic /<br> Professional Details
                </a>
            </li>
            <li class="nav-item" role="presentation">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="marital_status" id="marital_status" required>
                                    ...
                                    <option value="not_married" <?php if (isset($edit_data['marital_status']) && $edit_data['marital_status'] == 'not_married') echo 'selected'; ?>>Not Married</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control numberOnly" id="aadhar_no" name="aadhar_no" placeholder="0000 0000 0000 0000" required  value="<?= isset($edit_data['aadhar_no']) ? $edit_data['aadhar_no'] : '' ?>">
                            </div>
                        </div>
                       ...
                       <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="native_address" name="native_address" required rows="3"><?= isset($edit_data['native_address']) ? $edit_data['native_address'] : '' ?></textarea>
                            </div>
                        </div>
                        
                        <hr>
                        <!-- Parental/Guardian Information Section -->
                        <div class="col-12">
                            <h4>Parental/Guardian Information</h4>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="course" name="course" required>
                                ...
                                <?php foreach ($course as $val) { ?>
                                    <option value="<?= $val['id'] ?>" <?= isset($enrol_data['course_id']) && $enrol_data['course_id'] == $val['id'] ? 'selected' : '' ?>>
                                        <?= $val['title'] ?>
                                    </option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="batch_id" name="batch_id" required>
                                ...
                                <?php foreach ($batch as $val) { ?>
                                    <option value="<?= $val['id'] ?>" <?= isset($enrol_data['batch_id']) && $enrol_data['batch_id'] == $val['id'] ? 'selected' : '' ?>>
                                        <?= $val['title'] ?>
                                    </option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="enrollment_date" name="enrollment_date" required
                                value="<?= isset($enrol_data['enrollment_date']) ? $enrol_data['enrollment_date'] : '' ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="enrollment_status" name="enrollment_status" required>
                                ...
                                <option value="Active" <?= isset($enrol_data['enrollment_status']) && $enrol_data['enrollment_status'] == 'Active' ? 'selected' : '' ?>>Active</option>
                                <option value="On Hold" <?= isset($enrol_data['enrollment_status']) && $enrol_data['enrollment_status'] == 'On Hold' ? 'selected' : '' ?>>On Hold</option>
                                <option value="Dropped" <?= isset($enrol_data['enrollment_status']) && $enrol_data['enrollment_status'] == 'Dropped' ? 'selected' : '' ?>>Dropped</option>
                                <option value="Alumni" <?= isset($enrol_data['enrollment_status']) && $enrol_data['enrollment_status'] == 'Alumni' ? 'selected' : '' ?>>Alumni</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="mode_of_study" name="mode_of_study" required>
                                ...
                                <option value="Online" <?= isset($enrol_data['mode_of_study']) && $enrol_data['mode_of_study'] == 'Online' ? 'selected' : '' ?>>Online</option>
                                <option value="Offline" <?= isset($enrol_data['mode_of_study']) && $enrol_data['mode_of_study'] == 'Offline' ? 'selected' : '' ?>>Offline</option>
                                <option value="Hybrid" <?= isset($enrol_data['mode_of_study']) && $enrol_data['mode_of_study'] == 'Hybrid' ? 'selected' : '' ?>>Hybrid</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="preferred_language" name="preferred_language" required>
                                ...
                                <?php foreach ($language as $val) { ?>
                                    <option value="<?= $val['id'] ?>" <?= isset($enrol_data['preferred_language']) && $enrol_data['preferred_language'] == $val['id'] ? 'selected' : '' ?>>
                                        <?= $val['title'] ?>
                                    </option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="text-end mt-3">
                                <button class="btn btn-primary rounded-3 <?= isset($edit_data['user_id']) && !empty($this->data['edit_data']['course_id']) ? '' : 'disabled' ?>"
                                    onclick="show_ajax_modal('<?= base_url('admin/student_fee/add/' . (isset($edit_data['user_id']) ? $edit_data['user_id'] : '')) ?>', 'Add payment')">
                    ...
                    <form action="<?= base_url('admin/students/' . (isset($edit_data['user_id']) ? 'edit_info/' . $edit_data['user_id'] : 'add_info')) ?>" method="post" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="username" name="username" placeholder="Enter Username" required value="<?= isset($edit_data['username']) ? $edit_data['username'] : '' ?>" autocomplete="off">
                            </div>
                        </div>
