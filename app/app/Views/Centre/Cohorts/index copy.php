                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-soft-primary btn-sm">
                                            <a class=" dropdown-item edit-item-btn" href="<?=base_url('centre/cohorts/cohort_edit/'.$list_item['id'])?>">
                                        ...
                                        <button type="button" class="btn btn-soft-secondary btn-sm">
                                            <a class="dropdown-item edit-item-btn" href="<?=base_url('centre/cohorts/view/'.$list_item['id'])?>">
                                                <i class="ri-eye-line align-bottom me-2 "></i> View
                                            </a>
                                        </button>
                                        
                                        <button type="button" class="btn btn-soft-danger btn-sm">
                                            <a href="javascript::void()" class="dropdown-item remove-item-btn" onclick="delete_modal('<?=base_url('centre/cohorts/delete/'.$list_item['id'])?>')">
