<form autocomplete="off" action="<?= base_url('centre/live_class/add') ?>" id="addCohortLiveClassForm" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex align-items-start gap-3 mt-4">
                                <button type="button" id="liveClassSubmitBtn" class="btn btn-success btn-label right ms-auto nexttab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Save & Next</button>
                            </div>
                        </div> <!-- end row -->
                    </div>
                </div>
