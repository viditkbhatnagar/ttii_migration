...
<form autocomplete="off" id="addCohortBasicForm" method="post" enctype="multipart/form-data" action="<?= isset($edit_data) && $edit_data['id'] ? base_url('centre/cohorts/edit/'.$edit_data['id']) : base_url('centre/cohorts/add') ?>">
    <div class="row">
    ...
    <div class="d-flex align-items-start gap-3 mt-4">
        <a href="<?=base_url('centre/cohorts/')?>" class="btn btn-link text-decoration-none btn-label previestab" data-previous="pills-gen-info-tab">
...
<script>
    ...
    $('#course_id').change(function() {
        ...
        var cohortTitle = courseName.replace(/\s+/g, ' ') + ' - ' + year;
