            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <?php if (has_permission('students/add')) { ?>
                        <div class="col-4">
                            <a href="<?= base_url('centre/students/add/') ?>" class="btn btn-md btn-primary float-end">
                ...
                <div class="row">
                    <form method="get" action="">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-2 col-xxl-1 pt-md-1">
                                <a href="<?= base_url('centre/students/index') ?>" class="btn btn-danger w-100 mt-md-4 py-md-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <li class="list-unstyled">
                                        <a href="<?= base_url('centre/students/view/' . $student['id']) ?>" class="dropdown-item" >
                                        ...
                                        <!--        <li class="d-none">-->
                                        <!--            <a href="javascript::void()" class="dropdown-item" onclick="show_ajax_modal('<?= base_url('centre/students/view/' . $student['id']) ?>','View Student')">-->
                                        <!--                <i class="ri-eye-fill align-bottom me-2 text-muted"></i> View-->
                                        <!--            </a>-->
                                        <!--        </li>-->
                                        <!--        <li>-->
                                        ...
                                        <!--        </li>-->
                                        <!--        <li>-->
                                        <!--            <a href="<?= base_url('centre/students/edit/' . $student['id']) ?>" class="dropdown-item edit-item-btn">-->
                                        <!--                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit-->
                                        <!--            </a>-->
                                        <!--        </li>-->
                                        <!--        <li>-->
                                        <!--            <a href="javascript::void()" class="dropdown-item edit-item-btn"-->
                                        <!--                onclick="show_small_modal('<?= base_url('centre/students/ajax_edit_password/' . $student['id']) ?>', 'Edit Username and Password')">-->
                                        <!--                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Change Username/Password-->
                                        <!--            </a>-->
                                        <!--        </li>-->
                                        <!--        <li>-->
                                        <!--            <a href="javascript::void()" class="dropdown-item remove-item-btn" onclick="delete_modal('<?= base_url('centre/students/delete/' . $student['id']) ?>')">-->
