                            ...
                            <div class="col">
                                <div class="p-2">
                                    ...
                                    <div class="hstack -50 gap-1">
                                        <div class="text-white me-2"><i class="ri-map-pin-user-line me-1  text-opacity-75 fs-16 align-middle"></i><?=$view_data['address']?><br>
                                        <?=$view_data['district']?><br>
                                        <?=$view_data['state']?></div>
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted"><?=$view_data['date_of_birth']?></td>
                                                                    </tr>
                                                                     <tr>
