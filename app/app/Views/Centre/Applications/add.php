    ...
    <div class="d-flex justify-content-between align-items-center m-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="#" class="text-muted">Applicants</a></li>
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs mb-4" id="studentTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['id']) ? base_url('centre/applications/edit/' . $edit_data['id'] . '?active=1') : base_url('centre/applications/add?active=1') ?>"
            ...
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['id']) ? base_url('centre/applications/edit/' . $edit_data['id'] . '?active=2') : base_url('centre/applications/add?active=2') ?>"
            ...
            <li class="nav-item" role="presentation">
                <a href="<?= isset($edit_data['id']) ? base_url('centre/applications/edit/' . $edit_data['id'] . '?active=3') : base_url('centre/applications/add?active=3') ?>"
            ...
            <li class="nav-item d-none" role="presentation">
                <a href="<?= isset($edit_data['id']) ? base_url('centre/applications/edit/' . $edit_data['id'] . '?active=4') : base_url('centre/applications/add?active=4') ?>"
            ...
            <li class="nav-item d-none" role="presentation">
                <a href="<?= isset($edit_data['id']) ? base_url('centre/applications/edit/' . $edit_data['id'] . '?active=5') : base_url('centre/applications/add?active=5') ?>"
             ...
             <li class="nav-itemn d-none" role="presentation">
                <a href="<?= isset($edit_data['id']) ? base_url('centre/applications/edit/' . $edit_data['id'] . '?active=6') : base_url('centre/applications/add?active=6') ?>"
        ...
        <div class="tab-content" id="studentTabsContent">
            ...
            <div class="tab-pane fade <?= ($activeTab == 1) ? 'show active' : ''; ?>" id="basic" role="tabpanel">
               <form action="<?= base_url('centre/applications/' . (isset($edit_data['id']) ? 'edit/' . $edit_data['id'] : 'add')) ?>" method="post" enctype="multipart/form-data" id="basicForm">
                    <div class="row g-3">
                        <!-- Personal Information Section -->
                        <div class="col-12">
                            <h3>Personal Information</h3>
                        </div>
                        <input type="hidden" name="added_under_centre" value="<?= $added_under_centre ?>">
                        <!-- Profile Picture -->
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="whatsapp_no" class="form-label d-flex align-items-center">WhatsApp No
                                    <div class="form-check ms-1">
                                        <input class="form-check-input ms-1" type="radio" name="copy_option" id="copy_from_phone" value="phone">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select select2" name="country_id" id="country_id" onchange="getStates(this.options[this.selectedIndex].text)" required>
                                    <option value="0">Choose country</option>
                                    <?php foreach ($country_code as $code => $country) {
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select id="states" name="state" class="form-select select2" onchange="getDistrictsByState(this.value)" required>
                       ...
                       <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 mt-4">
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary" onclick="this.disabled=true; this.innerText='Saving...'; this.form.submit();">Save Student</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="tab-pane fade <?= ($activeTab == 2) ? 'show active' : ''; ?>" id="course" role="tabpanel">
                ...
                <?php endif; ?>
               <form action="<?= base_url('centre/applications/' . (isset($edit_data['id']) ? 'edit_education/' . $edit_data['id'] : 'add_education')) ?>" method="post" enctype="multipart/form-data" class="row g-3">
                                ...
                                <table class="table table-bordered">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th width="10%">Percentage / Grade</th>
                                            <th width="20%">Document Upload <small class="text-danger">**</small></th>
            ...
            <div class="tab-pane fade <?= ($activeTab == 3) ? 'show active' : ''; ?>" id="qualification" role="tabpanel">
                ...
                <form id="qualificationForm"
                    action="<?= isset($edit_data['id']) ? base_url('centre/applications/enrol_course/' . $edit_data['id']) : '#' ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="course" name="course" required>
                                ...
                                <?php foreach ($course as $val) { ?>
                                    <option value="<?= $val['course_id'] ?>" <?= isset($edit_data['course_id']) && $edit_data['course_id'] == $val['course_id'] ? 'selected' : '' ?> data-value = "<?= $val['assigned_amount'] ?>">
                                        <?= $val['course_title'] ?>
                                    </option>
                                <?php } ?>
                            </select>
                            <label id="courseValueLabel" style="display:none;color:red;"></label>
                        ...
                        <div class="col-12">
                            <div class="text-end mt-3">
                                <button class="btn btn-primary rounded-3 <?= isset($edit_data['id']) && !empty($this->data['edit_data']['course_id']) ? '' : 'disabled' ?>"
                                    onclick="show_ajax_modal('<?= base_url('centre/student_fee/add/' . (isset($edit_data['id']) ? $edit_data['id'] : '')) ?>', 'Add payment')">
                                            ...
                                            <?php if (isset($edit_data['id']) && !empty($this->data['edit_data']['course_id'])) : ?>
                                                <?php foreach ($payments as $key => $payment): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a onclick="show_ajax_modal('<?= base_url('centre/student_fee/edit/' . $payment['id']) ?>', 'Edit payment')" class="btn btn-sm btn-primary">
                                                                <i class="ri-pencil-line"></i>
                                                            </a>
                                                            <a onclick="delete_modal('<?= base_url('centre/student_fee/delete/?id=' . $payment['id'] . '&student_id=' . $payment['user_id']) ?>')" class="btn btn-sm btn-danger">
            ...
            <div class="tab-pane fade <?= ($activeTab == 5) ? 'show active' : ''; ?>" id="documents" role="tabpanel">
                ...
                <?php endif; ?>
                    ...
                    <div class="text-end">
                        <a class="btn mb-2 btn-secondary <?= isset($edit_data['id']) ? '' : 'disabled' ?>"
                            onclick="show_ajax_modal('<?= base_url('centre/applications/document_add/' . (isset($edit_data['id']) ? $edit_data['id'] : '')) ?>', 'Add Document')">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-secondary"
                                                        onclick="show_ajax_modal('<?= base_url('centre/applications/document_edit/' . $doc['student_document_id'] . '?student_id=' . $edit_data['id']) ?>', 'Update Document')">
                                                        Update
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        onclick="delete_modal('<?= base_url('centre/applications/document_delete/' . $doc['student_document_id'] . '?student_id=' . $edit_data['id']) ?>')">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
              ...
              <div class="tab-pane fade d-none <?= ($activeTab == 6) ? 'show active' : ''; ?>" id="lms" role="tabpanel">
                <div class="row g-3">
                    
                    <form action="<?= base_url('centre/applications/' . (isset($edit_data['id']) ? 'edit_info/' . $edit_data['id'] : 'add_info')) ?>" method="post" enctype="multipart/form-data" class="row g-3">
...
<script>
    ...
    $(document).on('change', '#course', function () {
        const amount = $(this).find('option:selected').attr('data-value');
        const label = $('#courseValueLabel');

        if (amount && amount !== "0") {
            label.text("    Assigned Course Value: ₹ " + amount).show();
        } else {
            label.text('').hide();
        }
    });
...
<script>
    ...
    function getCourses(university_id) {
        if (university_id) {
            $.ajax({
                url: '<?php echo base_url("centre/academic/get_courses/"); ?>' + university_id,
                type: 'GET',
...
document.getElementById("basicForm").addEventListener("submit", function (e) {
    ...
    let croppedImage = $('#user-profile-img').attr('src');
