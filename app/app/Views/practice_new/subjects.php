...
<html lang="en">
  ...
  <body>
    <section class="section-area">
      <!-- next section -->
      <form action="<?=base_url('home/practice_web_view_new/')?>" class="catogary-section">
    ...
    <script type="text/javascript">
        function submit_lessons(){
            ...
            window.location = '<?=base_url('exam/practice_web_view_new/'.$user_id.'/'.$course_id.'/?lesson_id=')?>' + lessons_a;
        }
    </script>
  </body>
</html>
