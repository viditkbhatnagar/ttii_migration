        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1.5">
              ...
              <Input id="au-name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Full Name" />
            </div>
            {!editingUser && (
              <div className="space-y-1.5">
                <Label htmlFor="au-email">Email</Label>
                <Input id="au-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" />
              </div>
            )}
            <div className="space-y-1.5">
              <Label htmlFor="au-phone">Phone</Label>
              <Input id="au-phone" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Phone" />
            </div>
            {!editingUser && (
              <>
                <div className="space-y-1.5">
                  <Label htmlFor="au-password">Password</Label>
                  <Input id="au-password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" />
                </div>
                <div className="space-y-1.5">
                  <Label htmlFor="au-confirm">Confirm Password</Label>
                  <Input id="au-confirm" type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm Password" />
                </div>
                <div className="space-y-1.5">
